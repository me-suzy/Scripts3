...
if($HTTP_COOKIE_VARS['loged'] == "yes") {
   if($HTTP_COOKIE_VARS['user_level'] == '1') {
	 ...
	 exit();
      ...
      $sql = "UPDATE ".$prefix."_themes SET name='$HTTP_POST_VARS[name]' WHERE id='$HTTP_POST_VARS[id]'";
      $result = $db->query($sql);
