...
# Use Rollover Images
	$_TCFG['_USE_ROLLOVER_IMAGES']      = 0;          // 1 = use "mouseover" images
											...
											// for ALL images
# Display page background image
	$_TCFG['PAGE_BACKGROUND']           = 1;		// Use the wrap-around page background images?
											// If "0", image will not be used and site content width will be as set in database
											// If "1", images WILL be used, and site content width will be set at 100%

# Body Tag Parameters
	$_TCFG['_TAG_BODY_BACK_COLOR']		= "#FFFFFF";	// Tag- Body Background Color (purple="#9933cc")
...
# Misc package images (in theme /images folder)
...
# Buttons / Img File URLS- Top Menu buttons- 30 px high
	...
	$_TCFG['_IMG_MT_ABOUT_US_B_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_about_us2.gif';
	$_TCFG['_IMG_MT_ARTICLES_B']		= $_PARM_PREFIX.'n_menu_top_news.gif'.'" alt="'.$_LANG['_THEME']['ALT_IMG_MT_ARTICLES_B'].'"'.$_PARM_SUFFIX;				// Image URL for: Articles Button (big)
	$_TCFG['_IMG_MT_ARTICLES_B_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_news.gif';
	...
	$_TCFG['_IMG_MT_CONTACT_B_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_contact2.gif';
	...
	$_TCFG['_IMG_MT_FAQ_B_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_faq2.gif';
	...
	$_TCFG['_IMG_MT_HELPDESK_B_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_helpdesk2.gif';
	...
	$_TCFG['_IMG_MT_HOME_B_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_home2.gif';
	...
	$_TCFG['_IMG_MT_HOSTING_B_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_hosting2.gif';
	...
	$_TCFG['_IMG_MT_LOGIN_B_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_login2.gif';
	...
	$_TCFG['_IMG_MT_LOGOUT_B_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_logout2.gif';
	...
	$_TCFG['_IMG_MT_ORDER_B_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_order2.gif';
	...
	$_TCFG['_IMG_MT_PLACE_ORDER_B_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_order2.gif';
	...
	$_TCFG['_IMG_MT_PLANS_B_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_plans2.gif';
	...
	$_TCFG['_IMG_MT_SEARCH_B_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_search2.gif';
	...
	$_TCFG['_IMG_MT_SERVICES_B_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_services2.gif';
	...
	$_TCFG['_IMG_MT_SUMMARY_B_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_menu_top_summary2.gif';
...
# Buttons / Img File URLS (medium ones- 27 px high)
	...
	$_TCFG['_IMG_VIEW_M_MO']			= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_med_view.gif';								// Image URL for: View Button (medium)
	...
	$_TCFG['_IMG_VIEW_ALL_M_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_med_view_all.gif';						// Image URL for: View All Button (medium)
...
# Buttons / Img File URLS (smallest ones- 25 px high)
	$_TCFG['_IMG_BLANK_S']			= $_PARM_PREFIX.'n_spacer.gif'.'" width="24" height="1" alt="'.$_LANG['_THEME']['ALT_IMG_BLANK_S'].'"'.$_PARM_SUFFIX;								// Image URL for: Blank Button (small)
	$_TCFG['_IMG_BLANK_S_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_spacer.gif';								// Image URL for: Blank Button (small)
...
# Buttons / Img File URLS (smallest ones- 25 px high) for CC Search output
	...
	$_TCFG['_S_IMG_CANCEL_S']		= $_PARM_PREFIX.'ni_cancel.gif'.'" alt="'.$_LANG['_THEME']['ALT_IMG_CANCEL_S'].'"'.$_PARM_SUFFIX;								// Image URL for: View Button (small)
	$_TCFG['_S_IMG_CANCEL_S_MO']		= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'ni_cancel.gif';								// Image URL for: View Button (small)
