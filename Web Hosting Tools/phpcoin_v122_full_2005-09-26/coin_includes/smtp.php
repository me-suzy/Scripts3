<?php
    /*
     * $Id: smtp.php,v 1.2 2005/05/23 19:49:26 stephen.kitching Exp $
     *
     * Description: Define an SMTP class that can be used to connect
     *              and communicate with any SMTP server. It implements
     *              all the SMTP functions defined in RFC821 except TURN.
     *
     * Creator: Chris Ryan <xgbe@yahoo.com>
     * Created: 03/26/2001
     *
     * TODO:
     ...
     *
     * 08/22/2001 - Chris Ryan <xgbe@yahoo.com>
     *              Added the Authenticate() method submitted by Brent Matzelle
     *              in response to the feature request #298.
     */

    /*
     * PhpSMTP library for using the SMTP protocol from PHP
    ...
    class SMTP {
        ...
        function Connect($host,$port=0,$tval=30) {
            ...
            # I have a report that on Windows systems this doesn't
            # behave properly.
        ...
        function Data($msg_data) {
            ...
            $max_line_length = 980; # used below; set here for ease in change
         ...
         *
         * Submitted by: "Brent R. Matzelle" <matzelle@activestrategy.com>
         */
