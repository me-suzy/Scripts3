 ...
 *
 * $Id: session.inc.php,v 1.45.2.1 2000/03/23 11:23:59 kk Exp $
 *
 */ 
...
class Session {
  ...
  var $gc_time  = 120;               ## Purge all session data older than 1440 minutes.
  var $gc_probability = 1;            ## Garbage collect probability in percent

  var $auto_init = "";                ## Name of the autoinit-File, if any.
  var $secure_auto_init = 0;          ## Set to 0 only, if all pages call
