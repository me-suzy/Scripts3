...
$location = "<a href=\"index.php?action=forum?action=forum\">$lang[textindex]</a>";
}
...
if($boardimg != "") {
$logo = "<tr><td><a href=\"index.php?action=forum?action=forum\"><img src=\"$boardimg\" alt=\"Board logo\" border=\"0\" /></a></td><td> </td></tr>";
}
