...
?>
<FORM ACTION="process_member_form.php" METHOD="POST">
	...
	<TR>
		...
		<td width="60%" bgcolor="#ffffff">
			<font color="#000000" face="arial">
				...
				<input type="hidden" name="old_user" value="<?php echo $row->user_name ?>">
	...
	<TR>
		<td width="100%" bgcolor="#cccccc" colspan="2" align="right">
			<font color="#000000" face="arial">
				...
				<a href="admin_members_process.php?id=<?php echo $row->id ?>"><font face="arial" size="2" color="red"><b>delete</b></font></a>
