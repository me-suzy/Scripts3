<!-- requestSupportForm.php -->
<form name="requestSupportForm" method="post" action="loginResult.php">
	<input type="hidden" name="task" value="Send the Request for Support">
...
<b>Comment</b><br>
<textarea name="userComments" rows=12 cols=60></textarea><br>
[use as much space as needed]

<br><br>


<input type="submit" name="submit" value="Request Support" class="submit">
<input type="checkbox" name="cc" CHECKED> CC me via email
