...
<tr>
	<td width="28%" valign="top" class="dotted" bordercolor="silver">
					...
					<h3>Register Now</h3>					
					<div align="center"><a href="register.php">Click here to Register</a></div>
					</p>
	...
	<td valign="top">
		<h1>Login</h1>
		<p>
			Submit this form to login.
		</p>
	<?php include("loginForm.php");?></td>
</tr>
</table>
