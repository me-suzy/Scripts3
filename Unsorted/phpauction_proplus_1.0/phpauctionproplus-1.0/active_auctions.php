...
#///////////////////////////////////////////////////////
	...
	/* get active auctions for this user */
			$result = mysql_query ( "SELECT * FROM PHPAUCTIONPROPLUS_auctions WHERE user='".addslashes($user_id)."' AND closed='0' ORDER BY starts DESC" );
	...
	/* get this user's nick */
			$query = "SELECT * FROM PHPAUCTIONPROPLUS_users WHERE id='".htmlspecialchars($user_id) . "'";
