...
#///////////////////////////////////////////////////////
   ...
   require('./includes/config.inc.php');
	...
	$query = "select * from PHPAUCTIONPROPLUS_winners 
		      WHERE
		      seller='$HTTP_SESSION_VARS[PHPAUCTION_LOGGED_IN]' 
		      AND
	...
	{
		include "header.php";
		include "templates/template_paysellerfee_error_php.html";
		include "footer.php";
		exit;
	}
	else
	{
            ...
            if($SETTINGS[sellerfinaltype] == 1)
            {
                ...
                $AMOUNT = ($PRICE / 100) * doubleval($SETTINGS[sellerfinalvalue]);
            }
            else
            {
...
require("header.php");
include "templates/template_paysellerfee_php.html";
include "./footer.php"; 
