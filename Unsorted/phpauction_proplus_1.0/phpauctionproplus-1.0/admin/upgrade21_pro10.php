...
<TR>
	<TD>
		...
		<TR>
			...
			&nbsp;&nbsp;
			<H1>Phpauction 2.1 to Pro Upgrade Script</H1>
			<BR>
			<BR>
			<FONT FACE=Helvetica SIZE=3>
			This upgrade script will upgrade your Phpauction installation from version 2.1 to Pro 1.0.
			<BR><BR>
			Before using the upgrade script, unpack the Phpauction Pro 1.0 distribution file you downloaded in 
			...
			<FORM ACTION=upgrade21_pro10_1.php>
			<center>
			<BR><BR>
