<?#//v.1.0.0
	...
	if(!@mysql_connect($CURRENT_DB_HOST,$CURRENT_DB_USER,$CURRENT_DBPASWORD))
	{
	...
	else
	{
		...
		if($R)
		{
			print "Importing data into PHPAUCTIONPROPLUS_adminusers<BR>";flush();
			...
			while($c = mysql_fetch_array($R))
			{
				...
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in adminusers table<BR>";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_auctions<BR>";flush();
			...
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in auctions table<BR>\n";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_bids<BR>";flush();
			while($c = mysql_fetch_array($R))
			{
				...
				if(!mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in bids table<BR>\n";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_categories<BR>";flush();
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in categories table<BR>\n";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_categories_plain<BR>";flush();
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in categories_plain table<BR>\n";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_counters<BR>";flush();
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in counters table<BR>\n";
				}
			}
		}
		...
		if($R)
		{
			...
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in durations table<BR>\n";
				}
			}
		}
		...
		if($R)
		{
			...
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in feedbacks table<BR>\n";
				}
			}
		}
		...
		if($R)
		{
			...
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in help table<BR>\n";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_increments<BR>";flush();
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in increments table<BR>\n";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_news<BR>";flush();
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in news table<BR>\n";
				}
			}
		}
		...
		if($R)
		{
			...
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in payments table<BR>\n";
				}
			}
		}
		...
		if($R)
		{
			...
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in request table<BR>\n";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_settings<BR>";flush();
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in settings table<BR>\n";
				}
			}
		}
		...
		{
			$N = mysql_select_db($NEW_DB_NAME);
			print "Importing data into PHPAUCTIONPROPLUS_users<BR>";flush();
			while($c = mysql_fetch_array($R))
			{
				...
				if(!@mysql_query($query))
				{
					print "*ERROR* $query<BR>".mysql_error()."<BR>while inserting in users table<BR>\n";
				}
			}
		}
	}
