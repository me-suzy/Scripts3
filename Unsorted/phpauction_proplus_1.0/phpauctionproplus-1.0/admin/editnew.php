...
#///////////////////////////////////////////////////////
	...
	if($action)
	{
		...
		else
		{
			...
			$query = "UPDATE PHPAUCTIONPROPLUS_news SET title='".addslashes($title)."',content='".addslashes($content)."',new_date=$date,suspended=".intval($suspended)." WHERE id='$id'";
