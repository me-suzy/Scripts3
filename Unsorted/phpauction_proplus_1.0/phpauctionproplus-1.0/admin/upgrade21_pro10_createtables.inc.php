...
<?
if(!@mysql_connect($DB_HOST,$DB_USER,$DB_PASSWORD)){ print "Connection failed!<BR>$DB_HOST,$DB_USER,$DB_PASSWORD"; exit;}
if(!@mysql_select_db($DB_NAME)){ print "Database selection failed!<BR>$DB_NAME<BR>".mysql_error(); exit;}

print "Creating PHPAUCTIONPROPLUS_accounts table... ";flush();
...
print "Creating PHPAUCTIONPROPLUS_feednacks table... ";
...
print "Creating PHPAUCTIONPROPLUS_request table... ";
