...
{
		 Header("Location: upgrade21_proplus10.php");
		 exit;
}
elseif($HTTP_POST_VARS[next] == "NEXT >>")
{
		...
		#//
  if(empty($HTTP_POST_VARS[CURRENT_PATH]) || empty($HTTP_POST_VARS[NEW_PATH]))
  {
		  $ERR = "Please, provide both your current Phpauction 2.1 installation path and your Phpauction Pro Plus installation path";
  }
  else
  {
 		 #// Are data correct?
		 	...
		 	{
			 	 #// Check file permission for the new installation
				  clearstatcache();
	 			 ...
	 			 else
		 		 {
 		  			...
 		  			#// Next Step
	 			  	Header("Location: upgrade21_proplus10_2.php");
		 			  exit;
 		 		}
 			}
  }
		     ...
		     <TABLE WIDTH=100% CELLPADDING=4 CELLSPACING=0 BORDER=0 BGCOLOR=white>
		       <TR>
			        <TD>
			          ...
			          &nbsp;&nbsp;
			          <H1>Phpauction Pro Plus Upgrade Script - STEP 1</H1>
			          <BR>
			          <BR>
		           ...
		           ?>
			          ...
			          <FORM ACTION="<?=basename($PHP_SELF)?>" METHOD=post>
			           ...
			           <INPUT TYPE=text SIZE=40 NAME=CURRENT_PATH VALUE=<?=$CURRENT_PATH?>><BR>
			            Path to your new (Phpauction Pro Plus) installation [NOTE: no ending slash (/) required]<BR>
