...
{
		Header("Location:upgrade21_proplus10_4.php");
		exit;
}
?>
<html>
		     ...
		     <TABLE WIDTH=100% CELLPADDING=4 CELLSPACING=0 BORDER=0 BGCOLOR=white>
		       <TR>
			        <TD>
			          ...
			          &nbsp;&nbsp;
			          <H1>Phpauction Pro Plus Upgrade Script - STEP 4</H1>
			          <BR>
			          <BR>
			          <?include "upgrade21_proplus10_createtables.inc.php";?>
			          <?include "upgrade21_proplus10_populatetables.inc.php";?>
			          <BR><BR>
               ...
               fclose($fp);
			          ...
			          Upgrade completed.
			          <BR>
			          You can now access your <A HREF=admin.php>administration back-end</A> to review the new installation's settings.
			          <BR>
