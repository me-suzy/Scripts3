<?#//v.1.0.0
	...
	{
		Header("Location: upgrade21_pro10_1.php");
		exit;
	}
	elseif($HTTP_POST_VARS[next] == "NEXT >>")
	{
					...
					if($HTTP_SESSION_VARS[DB] == "new")
					{
						...
						if(!$ERR)
						{
							...
							else
							{
								...
								#// Next Step
								Header("Location: upgrade21_pro10_3.php?L=$DB_NAME");
								exit;
							}
						}
					}
		...
		{
			#// Next Step
			Header("Location: upgrade21_pro10_3.php");
			exit;
		}					
	}
...
<TR>
	<TD>
		...
		<TR>
			...
			&nbsp;&nbsp;
			<H1>Phpauction Pro Upgrade Script - STEP 2
			</H1>
			<BR>
			<BR>
			<?
			...
			<B>New Phpauction Pro 1.0 installation information:</B>
			<UL>
			...
			<BR><BR>
			<FONT FACE=Helvetica SIZE=3>
			If the above data are correct press the <font face=COURIER>NEXT >></FONT> button below to proceed,
