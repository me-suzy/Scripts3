   ...
   require('../includes/time.inc.php');
	...
	if($HTTP_POST_VARS[action] == "update")
	{
		...
		$query = "update PHPAUCTIONPROPLUS_settings set 
				  sellerfinalfee=$HTTP_POST_VARS[sellerfinalfee],
				  sellerfinalvalue=$HTTP_POST_VARS[sellerfinalvalue],
				  sellerfinaltype=$HTTP_POST_VARS[sellerfinaltype]
				  ";
								...
								<TABLE WIDTH=100% CELLPADDING=2 ALIGN="CENTER" BGCOLOR="#FFFFFF">
									...
									<TR VALIGN="TOP"> 
										...
										<TD WIDTH="333" HEIGHT="22"><FONT FACE="Verdana, Verdana, Arial, Helvetica, sans-serif" SIZE="2"> 
											<INPUT TYPE="radio" NAME="sellerfinalfee" VALUE="1" <?if($SETTINGS[sellerfinalfee] == "1") print " CHECKED"?>>
											<? print $MSG_030; ?>
											<INPUT TYPE="radio" NAME="sellerfinalfee" VALUE="2" <?if($SETTINGS[sellerfinalfee] == "2") print " CHECKED"?>>
											<? print $MSG_029; ?>
											</FONT></TD>
									</TR>
									<TR VALIGN="TOP"> 
										...
										<TD WIDTH="333" HEIGHT="22"><FONT FACE="Verdana, Verdana, Arial, Helvetica, sans-serif" SIZE="2"> 
											<INPUT TYPE="text" NAME="sellerfinalvalue" SIZE="5" VALUE="<?=$SETTINGS[sellerfinalvalue];?>">
											<SELECT NAME="sellerfinaltype">
												<OPTION VALUE=1 <?if($SETTINGS[sellerfinaltype] == 1) print " SELECTED"?>>
												<?=$MSG_470?>
												</OPTION>
												<OPTION VALUE=2 <?if($SETTINGS[sellerfinaltype] == 2) print " SELECTED"?>>
												<?=$SETTINGS[currency]?>
												</OPTION>
											</SELECT>
											</FONT></TD>
