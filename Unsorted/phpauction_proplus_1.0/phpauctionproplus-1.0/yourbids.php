...
#///////////////////////////////////////////////////////
	...
	$result = mysql_query("select a.id, a.title, a.ends, b.bid FROM PHPAUCTIONPROPLUS_auctions a, PHPAUCTIONPROPLUS_bids b WHERE a.id=b.auction AND a.closed='0' AND b.bidder='$HTTP_SESSION_VARS[PHPAUCTION_LOGGED_IN]' order by a.ends asc, b.bidwhen desc");
