...
//	print $qp."<BR>";
	...
	$sql_count = "SELECT count(*) FROM PHPAUCTIONPROPLUS_auctions WHERE ( $qp1 ) AND ( closed='0') ORDER BY ends";
	$sql = "SELECT * FROM PHPAUCTIONPROPLUS_auctions WHERE ( $qp1 ) AND ( closed='0') ORDER BY ends";

	$sql_count_cat = "SELECT count(*) FROM PHPAUCTIONPROPLUS_categories WHERE ( $qpc1 ) ORDER BY cat_name ASC";
	$sql_cat = "SELECT * FROM PHPAUCTIONPROPLUS_categories WHERE ".$qp." ORDER BY cat_name ASC";
//	print $sql_cat."<BR>";
