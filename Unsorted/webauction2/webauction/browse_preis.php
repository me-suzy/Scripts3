   ...
   http://webauction.de.vu
        ...
        */
        ...
        if ($id==0)
        {
                ...
                */
                $result = mysql_query ( "SELECT * FROM ".$dbdix."_categories WHERE parent_id='0' ORDER BY cat_name" );
                if (!$result)
                {
                        ...
                        $TPL_categories_string = "Alle";
                                while ($row=mysql_fetch_array($result))
                                {
                                        ...
                                        */
                                        ...
                                        $TPL_main_value .= "        <TD WIDTH=\"33%\">$std_font<A HREF=\"browse_preis.php?SESSION_ID=$sessionIDU&id=".$row[cat_id]."\">".$row[cat_name]."</A>".$count_string."</FONT></TD>\n";
        ...
        else
        {
                ...
                */
                ...
                if (!$category)
                {
                        ...
                        header ( "Location: browse_preis.php?id=0" );
                        exit;
                }
                else
                {
                        ...
                        */
                        ...
                        while ( $par_id!=0 )
                        {
                                ...
                                $TPL_categories_string = "<A HREF=\"browse_preis.php?SESSION_ID=$sessionIDU&id=".$rw["cat_id"]."\">".$rw["cat_name"]."</A> &gt; ".$TPL_categories_string;
                        }
                        ...
                        /* get list of auctions of this category */
                                        $auctions_count = 0;
                                                ...
                                                if ($lines==0)        $lines = 50;
                                                        ...
                                                        $rsl = mysql_query ( "SELECT count(*) FROM ".$dbfix."_auctions WHERE category='$id' AND closed='0'" );
                                                        if ($rsl)
                                                        {
                                        ...
                                        $result = mysql_query ( "SELECT * FROM ".$dbfix."_auctions WHERE category='$id' AND closed='0' ORDER BY minimum_bid ASC LIMIT $left_limit,$lines" );
 ...
 /* Abfrage für current_bid ENDE  */
                                        ...
                                        for ($i=1; $i<=$pages; ++$i)
                                        {
                                                $TPL_auctions_list_value .=
                                                        ($page==$i)        ?
                                                                " $i "        :
                                                                " <A HREF=\"browse_preis.php?SESSION_ID=$sessionIDU&id=$id&page=$i\">$i</A> ";
                                        }
