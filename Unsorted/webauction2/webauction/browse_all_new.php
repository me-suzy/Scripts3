                        ...
                        $TPL_categories_string = "Alle";
                                while ($row=mysql_fetch_array($result))
                                {
                                        ...
                                        */
                                        ...
                                        $TPL_main_value .= "        <TD WIDTH=\"33%\">$std_font<A HREF=\"browse_all_new.php?SESSION_ID=$sessionIDU&id=".$row[cat_id]."\">".$row[cat_name]."</A>".$count_string."</FONT></TD>\n";
        ...
        else
        {
                ...
                */
                ...
                if (!$category)
                {
                        ...
                        header ( "Location: browse_all_new.php?id=0" );
                        exit;
                }
                else
                {
                        ...
                        */
                        ...
                        while ( $par_id!=0 )
                        {
                                ...
                                $TPL_categories_string = "<A HREF=\"browse_all_new.php?SESSION_ID=$sessionIDU&id=".$rw["cat_id"]."\">".$rw["cat_name"]."</A> &gt; ".$TPL_categories_string;
                        }
                        ...
                        /* get list of auctions of this category */
                                        ...
                                        $result = mysql_query ( "SELECT * FROM ".$dbfix."_auctions WHERE category='$id' AND closed='0' ORDER BY date DESC LIMIT $left_limit,$lines" );
                                ...
                                /* time left till the end of this subastas */
                                        ...
                                        for ($i=1; $i<=$pages; ++$i)
                                        {
                                                $TPL_auctions_list_value .=
                                                        ($page==$i)        ?
                                                                " $i "        :
                                                                " <A HREF=\"browse_all_new.php?SESSION_ID=$sessionIDU&id=$id&page=$i\">$i</A> ";
                                        }
