...
*/
	...
	/* get active auctions for this user */
			...
			$result = mysql_query ( "SELECT * FROM ".$dbfix."_auctions WHERE user='".addslashes($user_id)."' AND closed='0' ORDER BY date DESC" );
...

				{
					...
					$tplv .= "<TR ALIGN=CENTER VALIGN=MIDDLE BGCOLOR=\"$bgColor\">";
						...
						/* number of bids for this subastas */
							...
							$tplv .= "<TD><FONT FACE=\"Verdana,Helvetica,Arial\" SIZE=2>".$reserved_price.$num_bids."</FONT></TD>";
