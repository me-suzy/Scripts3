...
*/
        ...
        $result = mysql_query ( "SELECT * FROM ".$dbfix."_auctions WHERE closed='0' and ends <= '$datumswert2' ORDER BY ends " );
        ...
        $auctions_count = 0;
                                                ...
                                                if ($lines==0)        $lines = 25;
                                                        ...
                                                        $rsl = mysql_query ("SELECT count(*) from ".$dbfix."_auctions WHERE closed='0' and ends <= '$datumswert2' " );
                                                        if ($rsl)
                                                        {
                ...
                $TPL_auctions_list_value = $tplv;
                                        ...
                                        for ($i=1; $i<=$pages; ++$i)
                                        {
                                                $TPL_auctions_list_value .=
                                                        ($page==$i)        ?
                                                                " $i "        :
                                                                " <A HREF=\"view_more_ending.php?page=$i\">$i</A> ";
                                        }
