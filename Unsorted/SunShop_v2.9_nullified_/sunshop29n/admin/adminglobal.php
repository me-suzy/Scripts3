...
$DB_site->appname="SunShop Administration";
...
function getuseraccess ($ID) {
    global $DB_site, $dbprefix, $IN_USER, $IN_PW;
	if ($ID != "") {
		$tempq=$DB_site->query("SELECT * FROM ".$dbprefix."user where userid='$ID' AND name='Add_Admin'");
	} else {
		$tempq=$DB_site->query("SELECT * FROM ".$dbprefix."user where username='$IN_USER' AND password='$IN_PW' AND name='Add_Admin'");
	}
	$temp=$DB_site->fetch_array($tempq);
    $accessnum = explode(":", $temp[address_line1]);
	for($i=1;$i<9;$i++) {
		$out[$i] = $accessnum[$i-1];
	}
    return $out;
	...
	?>
		...
		<table border="0" cellspacing="2" cellpadding="2">
			...
			<tr>
				...
				<td width="40">&nbsp;</td>
				<td><a href="#sd"><li>Shop Settings</li></td>
			</tr>
			<tr>
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="Navy">
			<tr>
				...
				<tr>
				<td width="250" bgcolor="#E9E9E9"><b>Automatic Shipping Calculator: </b><br>(Best Method)</td>
				<td bgcolor="#E9E9E9"><input type="radio" name="shipcalc" value="Yes"
				<?PHP
				if ($shipcalc == "Yes") { print("checked"); }
				?>
				>Yes&nbsp;<input type="radio" name="shipcalc" value="No"
				<?PHP
				if ($shipcalc == "No") { print("checked"); }
				?>
				>No</td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">UPS <input type="radio" name="shipups" value="Yes"
				<?PHP
				...
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">USPS <input type="radio" name="shipusps" value="Yes"
				<?PHP
				if ($shipusps == "Yes") { print("checked"); }
				?>
				>Yes&nbsp;<input type="radio" name="shipusps" value="No"
				<?PHP
				if ($shipusps == "No") { print("checked"); }
				?>
				>No</td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td align="left" bgcolor="#E9E9E9">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="2">
							<tr>
								<td>Server URL:</td>
								<td><input type="text" name="uspsserver" value="<?PHP echo $uspsserver ?>"></td>
							</tr>
							<tr>
								<td>Username:</td>
								<td><input type="text" name="uspsuser" value="<?PHP echo $uspsuser ?>"></td>
							</tr>
							<tr>
								<td>Password:</td>
								<td><input type="text" name="uspspass" value="<?PHP echo $uspspass ?>"></td>
							</tr>
						</table>
						</td>
						</tr>
				...
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">UPS and USPS realtime shipping calculator. If this is set to "Yes", all
				...
				?>
				>Per Item&nbsp;<input type="radio" name="method" value="percentage"
				<?PHP
				if ($method == "percentage") { print("checked"); }
				?>
				>Percentage<br>
				...
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">Fixed shipping cost. For percentage use decimal value.<br><br></td></tr>
		        </table>
				</td>
			</tr>
	    </table><br>
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="Navy">
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="4">
				<tr><td colspan="2" bgcolor="Navy">
				<div align="center"><b><font color="White"><a name="sd"></a>Shop Settings</font></b></div></td></tr>
				...
				?>
				>By Price&nbsp;<input type="radio" name="orderby" value="sku"
				<?PHP
				if ($orderby == "sku") { print("checked"); }
				?>
				>Sku Number&nbsp;<input type="radio" name="orderby" value="sold"
				<?PHP
				if ($orderby == "sold") { print("checked"); }
				?>
				>Number Sold</td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				...
				?>
				>Pictures Only&nbsp;<input type="radio" name="showitem" value="list"
				<?PHP
				if ($showitem == "list") { print("checked"); }
				?>
				>List Style With Images</td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">Would you like to show the items with their pictures or just list them with images and text?<br></td></tr>
				
				<tr>
				<td bgcolor="#C0C0C0" valign="top"><b>Show Bestsellers?</b></td>
				<td bgcolor="#C0C0C0"><input type="radio" name="showbestsellers" value="Yes" 
				<?PHP
				if ($showbestsellers == "Yes") { print("checked"); }
				?>
				>Yes&nbsp;<input type="radio" name="showbestsellers" value="No"
				<?PHP
				if ($showbestsellers == "No") { print("checked"); }
				?>
				>No</td>
				</tr>
				<tr><td bgcolor="#C0C0C0">&nbsp;</td>
				<td bgcolor="#C0C0C0">Would you like to show the bestsellers in the category column?<br></td></tr>
				
				<tr>
				<td bgcolor="#E9E9E9" valign="top"><b>Show Specials?</b></td>
				<td bgcolor="#E9E9E9"><input type="radio" name="showspecials" value="Yes" 
				<?PHP
				if ($showspecials == "Yes") { print("checked"); }
				?>
				>Yes&nbsp;<input type="radio" name="showspecials" value="No"
				<?PHP
				if ($showspecials == "No") { print("checked"); }
				?>
				>No</td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">Would you like to show the specials in the category column? Setting to "No" will remove the specials table as well.<br></td></tr>
				
				<tr>
				<td bgcolor="#C0C0C0" valign="top"><b>Show Category Totals?</b></td>
				<td bgcolor="#C0C0C0"><input type="radio" name="showcattotals" value="Yes" 
				<?PHP
				if ($showcattotals == "Yes") { print("checked"); }
				?>
				>Yes&nbsp;<input type="radio" name="showcattotals" value="No"
				<?PHP
				if ($showcattotals == "No") { print("checked"); }
				?>
				>No</td>
				</tr>
				<tr><td bgcolor="#C0C0C0">&nbsp;</td>
				<td bgcolor="#C0C0C0">Would you like to show the category totals at the end of each category and sub category?<br></td></tr>
				
				<tr>
				<td bgcolor="#E9E9E9" valign="top"><b>Language File:</b></td>
				<td bgcolor="#E9E9E9">
				<select name="language">
				<?PHP
				$the_directory = opendir("../lang");
				while($filename = readdir($the_directory)) { 
				     if ($filename != "." && $filename != "..") {
					     $success = @include("../lang/".$filename); 
						 if (!$success) { $lang_lang = "Unkown"; }
						 if ($lang == "lang/".$filename) {
							 print("<option value=\"lang/$filename\" selected>$lang_lang: $filename</option>");
						 } else {
							 print("<option value=\"lang/$filename\">$lang_lang: $filename</option>");
						 }
					 }
				}
				...
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">Please choose your language file.<br></td></tr>	
				
				<tr>
				<td bgcolor="#C0C0C0" valign="top"><b>Items Per Page:</b></td>
				<td bgcolor="#C0C0C0"><input type="text" name="itemsperpage" size="3" value="<?PHP echo $itemsperpage ?>"></td>
				</tr>
				<tr><td bgcolor="#C0C0C0">&nbsp;</td>
				<td bgcolor="#C0C0C0">How many items would you like to display per page?<br></td></tr>
				
				<tr>
				<td bgcolor="#E9E9E9" valign="top"><b>Users Must Signup?</b></td>
				<td bgcolor="#E9E9E9"><input type="radio" name="mustsignup" value="Yes" 
				<?PHP
				if ($mustsignup == "Yes") { print("checked"); }
				?>
				>Yes&nbsp;<input type="radio" name="mustsignup" value="No"
				<?PHP
				if ($mustsignup == "No") { print("checked"); }
				?>
				>No</td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">Will customers have to signup to shop on your site??<br></td></tr>
				...
				<tr>
				<td valign="top" bgcolor="#E9E9E9"><b>Sub Categories Display:</b></td>
				<td bgcolor="#E9E9E9"><input type="text" name="catsdisplay" size="3" value="<?PHP echo $catsdisplay ?>"></td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">How many subcategories would you like to display at a time? Set to 0 to show all.<br></td></tr>
				
				<tr>
				<td valign="top" bgcolor="#C0C0C0"><b>Header:</b></td>
				
				<td bgcolor="#C0C0C0"><input type="radio" name="useheader" value="Yes" <?PHP if ($useheader == "Yes") { print("checked"); } ?>> Use Template<br>
								      <input type="radio" name="useheader" value="No" <?PHP if ($useheader == "No") { print("checked"); } ?>> Use Header File: <input type="text" name="myheader" size="20" value="<?PHP echo $myheader ?>">
				</td>
				</tr>
				<tr><td bgcolor="#C0C0C0">&nbsp;</td>
				...
				<td bgcolor="#E9E9E9"><input type="radio" name="usefooter" value="Yes" <?PHP if ($usefooter == "Yes") { print("checked"); } ?>> Use Template<br>
				                      <input type="radio" name="usefooter" value="No" <?PHP if ($usefooter == "No") { print("checked"); } ?>> Use Footer File: <input type="text" name="myfooter" size="20" value="<?PHP echo $myfooter ?>">
				</td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				...
				<tr>
				<td valign="top" bgcolor="#C0C0C0"><b>Secure Header:</b></td>
				
				<td bgcolor="#C0C0C0"><input type="radio" name="usesecureheader" value="Yes" <?PHP if ($usesecureheader == "Yes") { print("checked"); } ?>> Use Template<br>
								      <input type="radio" name="usesecureheader" value="No" <?PHP if ($usesecureheader == "No") { print("checked"); } ?>> Use Secure Header File: <input type="text" name="mysecureheader" size="20" value="<?PHP echo $mysecureheader ?>">
				</td>
				</tr>
				<tr><td bgcolor="#C0C0C0">&nbsp;</td>
				<td bgcolor="#C0C0C0">Secure header. Appears at the top of every secure page. You may use the built in or define your own file.<br></td></tr>
				
				<tr>
				<td valign="top" bgcolor="#E9E9E9"><b>Secure Footer:</b></td>
				<td bgcolor="#E9E9E9"><input type="radio" name="usesecurefooter" value="Yes" <?PHP if ($usesecurefooter == "Yes") { print("checked"); } ?>> Use Template<br>
				                      <input type="radio" name="usesecurefooter" value="No" <?PHP if ($usesecurefooter == "No") { print("checked"); } ?>> Use Secure Footer File: <input type="text" name="mysecurefooter" size="20" value="<?PHP echo $mysecurefooter ?>">
				</td>
				</tr>
				<tr><td bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">Secure header. Appears at the bottom of every secure page. You may use the built in or define your own file.<br></td></tr>
				...
				<tr>
				<td bgcolor="#C0C0C0"><b>General Table Width:</b></td>
				<td bgcolor="#C0C0C0"><input type="text" size="4" name="allwidth" value="<?PHP echo $allwidth ?>"></td>
				</tr>
				<tr><td bgcolor="#C0C0C0">&nbsp;</td>
				<td bgcolor="#C0C0C0">Width of all tables combined. To have the cart extend across the whole page set to 100%.<br></td></tr>
				
				
				<tr>
				<td valign="top" bgcolor="#E9E9E9"><b>Side Table Settings:</b></td>
				<td bgcolor="#E9E9E9">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					    <tr>
						<td bgcolor="#E9E9E9" width="230"><b>Table Width:</b></td>
						<td bgcolor="#E9E9E9"><input type="text" size="4" name="tablewidth" value="<?PHP echo $tablewidth ?>"></td>
						</tr>
				...
				<tr>
				<td valign="top" bgcolor="#E9E9E9">&nbsp;</td>
				<td bgcolor="#E9E9E9">The side tables are the tables displayed on the left and right of the screen ("Category Index" and "Account Login"). Specify the properties for those tables.</td>
				</tr>
				
				<tr>
				<td valign="top" bgcolor="#C0C0C0"><b>Center Table Settings:</b></td>
				<td bgcolor="#C0C0C0">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					    <tr>
						<td bgcolor="#C0C0C0" width="230"><b>Table Width:</b></td>
						<td bgcolor="#C0C0C0"><input type="text" size="4" name="centerwidth" value="<?PHP echo $centerwidth ?>"></td>
						</tr>
				...
				<td bgcolor="#C0C0C0">Center table is the main table that displays content.</td>
				</tr>
		        </table>
				</td>
			</tr>
...
<div align="left"><br>
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
		...
		<tr>
			...
			<td bgcolor="Silver">$139.99 United States Dollars</td>
		</tr>
		<tr>
		...
		<tr>
			<td width="100" valign="top">ForumRu Price</td>
			<td>$00.00 Always 100% Free</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver">CGIHAVEN Price</td>
			<td bgcolor="Silver">$00.00 Always 100% Free</td>
		</tr>
		<tr>
...
function sqldumptable($table) {
  global $DB_site;
  $tabledump = "\$query=\$DB_site->query(\"DROP TABLE IF EXISTS $table\");\n";
  $tabledump .= "\$query=\$DB_site->query(\"CREATE TABLE $table (\n";
  $firstfield=1;
  ...
  while ($row = $DB_site->fetch_array($rows)) {
    $tabledump .= "\$query=\$DB_site->query(\"INSERT INTO $table VALUES(";
    $fieldcounter=-1;
    $firstfield=1;
    while (++$fieldcounter<$numfields) {
      ...
      if (!isset($row[$fieldcounter])) {
        ...
        $tabledump .= "'".addslashes(stripslashes(stripslashes(stripslashes($row[$fieldcounter]))))."'";
      }
    }
    $tabledump .= ")\");\n";
  }
...
// ###################### cc decrypt #######################
function decryptit ($cc) {
	$cclen = strlen($cc);
	$decrypted = "";
	$noletters = 0;
	for ($i=0;$i<$cclen;$i=$i+2) {
	    $letters = substr($cc, $i, 2);
	    if ($letters=="NM") { $decrypted = $decrypted."0"; }
		elseif ($letters=="OL") { $decrypted = $decrypted."1"; }
		elseif ($letters=="PK") { $decrypted = $decrypted."2"; }
		elseif ($letters=="QJ") { $decrypted = $decrypted."3"; }
		elseif ($letters=="RI") { $decrypted = $decrypted."4"; }
		elseif ($letters=="SH") { $decrypted = $decrypted."5"; }
		elseif ($letters=="TG") { $decrypted = $decrypted."6"; }
		elseif ($letters=="UF") { $decrypted = $decrypted."7"; }
		elseif ($letters=="VE") { $decrypted = $decrypted."8"; }
		elseif ($letters=="WD") { $decrypted = $decrypted."9"; }
		else { $noletters = 1; }
	}
	if ($noletters == 1) {
	    return $cc;
...
function adminauthenticate ($login, $password) {
    ...
    while ($row=$DB_site->fetch_array($temps)) {
		if ($password == $row[password]) {
		   if ($row[name] == "Admin_Account" || $row[name] == "Add_Admin") {
		       $DB_site->query("UPDATE ".$dbprefix."user set lastvisit='".date("m/d/y h:ia")."' where username='$login'");
			   session_register("IN_PW");
			   session_register("IN_USER");
			   $result = "valid";
		   } else {
		       $result = "invalid";
		   }
...
// ##################### getuser ##################
function getuser ($ID) {
    global $DB_site, $dbprefix, $IN_USER;
	if (!isset($ID) || $ID == "") {
		$temps=$DB_site->query("SELECT * FROM ".$dbprefix."user where username='$IN_USER'");
	} else {
...
function iteminfo ($id) {
    ...
    while ($row=$DB_site->fetch_array($temps)) {
		...
		$iteminfo[viewable] = stripslashes($row[viewable]); $iteminfo[option1] = stripslashes($row[option1]);
		$iteminfo[option12] = stripslashes($row[option12]); $iteminfo[option2] = stripslashes($row[option2]);
		$iteminfo[option22] = stripslashes($row[option22]); $iteminfo[option3] = stripslashes($row[option3]);
		$iteminfo[option32] = stripslashes($row[option32]); $iteminfo[payop] = stripslashes($row[payop]);
		$iteminfo[itemid] = stripslashes($row[itemid]); $iteminfo[sku] = stripslashes($row[sku]);
...
function viewuser ($ID) {
	...
	<table>
		...
		<tr>
			<td><b>Email:</b></td>
			<td><a href="mailto:<?PHP echo $userinfo[email] ?>"><?PHP echo $userinfo[email] ?></a></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><?PHP echo $userinfo[baddress_line1] ?><br>
...
function viewaccount ($ID) {
	...
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
		<tr>
			...
			<td wisth="*" bgcolor="Silver"><?PHP echo $userinfo[username] ?></td>
		</tr>
				<tr>
		...
		<tr>
			...
			<td bgcolor="Silver"><?PHP echo $userinfo[name] ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td bgcolor="Silver"><a href="mailto:<?PHP echo $userinfo[email] ?>"><?PHP echo $userinfo[email] ?></a></td>
		</tr>
		<tr>
			<td width="100">&nbsp;</td>
		...
		<tr>
			...
			<td><?PHP echo $userinfo[address_line1] ?></td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Address 2:</b></td>
			<td bgcolor="Silver"><?PHP echo $userinfo[address_line2] ?>&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td bgcolor="Silver"><?PHP echo $userinfo[state] ?></td>
		</tr>
		<tr>
			<td width="100"><b>Zip/Postal Code:</b></td>
			<td><?PHP echo $userinfo[zip] ?></td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Country:</b></td>
			<td bgcolor="Silver"><?PHP echo $userinfo[country] ?></td>
		</tr>
		<tr>
			<td width="100">&nbsp;</td>
		...
		<tr>
			<td width="100"><b>Address 1:</b></td>
			<td><?PHP echo $userinfo[baddress_line1] ?></td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Address 2:</b></td>
			<td bgcolor="Silver"><?PHP echo $userinfo[baddress_line2] ?>&nbsp;</td>
		</tr>
		<tr>
			<td width="100"><b>City:</b></td>
			<td><?PHP echo $userinfo[bcity] ?></td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>State/Province:</b></td>
			<td bgcolor="Silver"><?PHP echo $userinfo[bstate] ?></td>
		</tr>
		<tr>
			<td width="100"><b>Zip/Postal Code:</b></td>
			<td><?PHP echo $userinfo[bzip] ?></td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Country:</b></td>
			<td bgcolor="Silver"><?PHP echo $userinfo[bcountry] ?></td>
		</tr>
	</table></div><br>	
	<?PHP
}
...
function addadmin () {
    global $error;
	?>
	<div align="left"><b><font color="Navy">Add Admin:</font></b><br><br>
	<form action="admin.php?action=storeadmin" method="post">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
		<tr>
			<td width="100" bgcolor="Silver"><b>Login:</b></td>
			<td bgcolor="Silver"><input type="text" name="username" size="10" value="<?PHP echo $username ?>"> <?PHP if (isset($error) || $error != "") { echo "<font color=\"#FF0000\">Username In Use!</font>";  } ?></td>
		</tr>
				<tr>
			<td width="100"><b>Password:</b></td>
		...
		<tr>
			<td width="100" valign="top" bgcolor="#C0C0C0"><b>Permissions:</b></td>
			<td bgcolor="Silver">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>Maintain Users/Admins:</td>
					<td><input type="radio" name="access[1]" value="1">Yes&nbsp;&nbsp;<input type="radio" name="access[1]" value="2">No</td>
				</tr>
				<tr>
					<td>Maintain Categories/Subcategories:</td>
					<td><input type="radio" name="access[2]" value="1">Yes&nbsp;&nbsp;<input type="radio" name="access[2]" value="2">No</td>
				</tr>
				<tr>
					<td>Maintain Products/Options/Fields:</td>
					<td><input type="radio" name="access[3]" value="1">Yes&nbsp;&nbsp;<input type="radio" name="access[3]" value="2">No</td>
				</tr>
				<tr>
					<td>Maintain Specials/Coupons/Discounts:</td>
					<td><input type="radio" name="access[4]" value="1">Yes&nbsp;&nbsp;<input type="radio" name="access[4]" value="2">No</td>
				</tr>
				<tr>
					<td>Maintain Transactions:</td>
					<td><input type="radio" name="access[5]" value="1">Yes&nbsp;&nbsp;<input type="radio" name="access[5]" value="2">No</td>
				</tr>
				<tr>
					<td>Maintain Templates:</td>
					<td><input type="radio" name="access[6]" value="1">Yes&nbsp;&nbsp;<input type="radio" name="access[6]" value="2">No</td>
				</tr>
				<tr>
					<td>Maintain Settings:</td>
					<td><input type="radio" name="access[7]" value="1">Yes&nbsp;&nbsp;<input type="radio" name="access[7]" value="2">No</td>
				</tr>
				<tr>
					<td>Maintain Backups:</td>
					<td><input type="radio" name="access[8]" value="1">Yes&nbsp;&nbsp;<input type="radio" name="access[8]" value="2">No</td>
				</tr>
			</table>
...
function editadmin ($ID) {
    $userinfo = getuser ($ID);
	$access = getuseraccess ($ID);
	?>
	<div align="left"><b><font color="Navy">Edit Admin:</font></b><br><br>
	<form action="admin.php?action=updateadmin" method="post">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
		<tr>
			<td width="100" bgcolor="Silver"><b>Login:</b></td>
			<td bgcolor="Silver"><?PHP echo $userinfo[username] ?><input type="hidden" name="username" value="<?PHP echo $userinfo[username] ?>"></td>
		</tr>
				<tr>
			<td width="100"><b>Password:</b></td>
			<td><input type="text" name="password" size="10" value="<?PHP echo $userinfo[password] ?>">
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Permissions:</b></td>
			<td bgcolor="Silver">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>Maintain Users/Admins:</td>
					<td><input type="radio" name="access[1]" value="1" <?PHP if ($access[1] == 1) { echo "checked"; } ?>>Yes&nbsp;&nbsp;<input type="radio" name="access[1]" value="2" <?PHP if ($access[1] == 2) { echo "checked"; } ?>>No</td>
				</tr>
				<tr>
					<td>Maintain Categories/Subcategories:</td>
					<td><input type="radio" name="access[2]" value="1" <?PHP if ($access[2] == 1) { echo "checked"; } ?>>Yes&nbsp;&nbsp;<input type="radio" name="access[2]" value="2" <?PHP if ($access[2] == 2) { echo "checked"; } ?>>No</td>
				</tr>
				<tr>
					<td>Maintain Products/Options/Fields:</td>
					<td><input type="radio" name="access[3]" value="1" <?PHP if ($access[3] == 1) { echo "checked"; } ?>>Yes&nbsp;&nbsp;<input type="radio" name="access[3]" value="2" <?PHP if ($access[3] == 2) { echo "checked"; } ?>>No</td>
				</tr>
				<tr>
					<td>Maintain Specials/Coupons/Discounts:</td>
					<td><input type="radio" name="access[4]" value="1" <?PHP if ($access[4] == 1) { echo "checked"; } ?>>Yes&nbsp;&nbsp;<input type="radio" name="access[4]" value="2" <?PHP if ($access[4] == 2) { echo "checked"; } ?>>No</td>
				</tr>
				<tr>
					<td>Maintain Transactions:</td>
					<td><input type="radio" name="access[5]" value="1" <?PHP if ($access[5] == 1) { echo "checked"; } ?>>Yes&nbsp;&nbsp;<input type="radio" name="access[5]" value="2" <?PHP if ($access[5] == 2) { echo "checked"; } ?>>No</td>
				</tr>
				<tr>
					<td>Maintain Templates:</td>
					<td><input type="radio" name="access[6]" value="1" <?PHP if ($access[6] == 1) { echo "checked"; } ?>>Yes&nbsp;&nbsp;<input type="radio" name="access[6]" value="2" <?PHP if ($access[6] == 2) { echo "checked"; } ?>>No</td>
				</tr>
				<tr>
					<td>Maintain Settings:</td>
					<td><input type="radio" name="access[7]" value="1" <?PHP if ($access[7] == 1) { echo "checked"; } ?>>Yes&nbsp;&nbsp;<input type="radio" name="access[7]" value="2" <?PHP if ($access[7] == 2) { echo "checked"; } ?>>No</td>
				</tr>
				<tr>
					<td>Maintain Backups:</td>
					<td><input type="radio" name="access[8]" value="1" <?PHP if ($access[8] == 1) { echo "checked"; } ?>>Yes&nbsp;&nbsp;<input type="radio" name="access[8]" value="2" <?PHP if ($access[8] == 2) { echo "checked"; } ?>>No</td>
				</tr>
			</table>
			</td>
		</tr>
...
function editaccount ($ID) {
	...
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
		...
		<tr>
			<td width="100" bgcolor="Silver"><b>Full Name:</b></td>
			<td bgcolor="Silver"><input type="text" name="name" size="20" value="<?PHP echo $userinfo[name] ?>">
			</td>
		</tr>
		<tr>
			<td width="100"><b>Phone:</b></td>
			<td><input type="text" name="phone" size="15" value="<?PHP echo $userinfo[phone] ?>">
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Email:</b></td>
			<td bgcolor="Silver"><input type="text" name="email" size="25" value="<?PHP echo $userinfo[email] ?>">
			</td>
		</tr>
		<tr>
			<td width="100">&nbsp;</td>
		...
		<tr>
			<td width="100"><b>Address 1:</b></td>
			<td><input type="text" name="address_line1" size="20" value="<?PHP echo $userinfo[address_line1] ?>">
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Address 2:</b></td>
			<td bgcolor="Silver"><input type="text" name="address_line2" size="20" value="<?PHP echo $userinfo[address_line2] ?>">
			</td>
		</tr>
		<tr>
			<td width="100"><b>City:</b></td>
			<td><input type="text" name="city" size="10" value="<?PHP echo $userinfo[city] ?>">
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>State/Province:</b></td>
			<td bgcolor="Silver"><select NAME="state">
				<option VALUE="<?PHP echo $userinfo[state] ?>"><?PHP echo $userinfo[state] ?>
				<?PHP echo $state_list ?>
				</select>
	         </td>
		</tr>
		<tr>
			<td width="100"><b>Zip/Postal Code:</b></td>
			<td><input type="text" name="zip" size="10" value="<?PHP echo $userinfo[zip] ?>">
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Country:</b></td>
			<td bgcolor="Silver"><select NAME="country">
				 <option VALUE="<?PHP echo $userinfo[country] ?>"><?PHP echo $userinfo[country] ?>
				 <?PHP echo $countries_list ?>
				</SELECT>
			</td>
		</tr>
		...
		<tr>
			<td width="100"><b>Address 1:</b></td>
			<td><input type="text" name="baddress_line1" size="20" value="<?PHP echo $userinfo[baddress_line1] ?>">
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Address 2:</b></td>
			<td bgcolor="Silver"><input type="text" name="baddress_line2" size="20" value="<?PHP echo $userinfo[baddress_line2] ?>">
			</td>
		</tr>
		<tr>
			<td width="100"><b>City:</b></td>
			<td><input type="text" name="bcity" size="10" value="<?PHP echo $userinfo[bcity] ?>">
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>State/Province:</b></td>
			<td bgcolor="Silver"><select NAME="bstate">
				<option VALUE="<?PHP echo $userinfo[bstate] ?>"><?PHP echo $userinfo[bstate] ?>
				<?PHP echo $state_list ?>
				</select>
	         </td>
		</tr>
		<tr>
			<td width="100"><b>Zip/Postal Code:</b></td>
			<td><input type="text" name="bzip" size="10" value="<?PHP echo $userinfo[bzip] ?>">
			</td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver"><b>Country:</b></td>
			<td bgcolor="Silver"><select NAME="bcountry">
				 <option VALUE="<?PHP echo $userinfo[bcountry] ?>"><?PHP echo $userinfo[bcountry] ?>
				 <?PHP echo $countries_list  ?>
				</SELECT>
			</td>
		</tr>
...
function additems () {
	...
	<form action="admin.php?action=storeitem" method="post" enctype="multipart/form-data">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
	    <tr>
			<td bgcolor="Silver"><b>SKU#:</b> (Optional)</td>
			<td bgcolor="Silver"><input type="text" name="sku" size="25"></td>
		</tr>
		<tr>
			<td><b>Category:</b></td>
			<td>
			...
			while ($row=$DB_site->fetch_array($temp)) {
			     print("<option value=\"$row[categoryid]\">".stripslashes($row[title])."</option>"); 
			}
			?>
			</select>
			</td>
		...
		<tr>
			...
			while ($row=$DB_site->fetch_array($temp)) {
			     ...
			     print("<option value=\"$row[subcategoryid]\">".stripslashes($row2[title])." -> ".stripslashes($row[title])."</option>"); 
			}
			?>
			</select>
			</td>
		...
		<tr>
			...
			<td bgcolor="Silver"><input type="file" name="imagename" size="20" accept="image/jpeg,image/gif"><br>(Displays at <?PHP echo $picwidth ?> x <?PHP echo $picheight ?>)</td>
		</tr>
		<tr>
			<td valign="top"><b>Thumbnail:</b></td>
			<td><input type="file" name="thumb" size="20" accept="image/jpeg,image/gif"><br>(Displays at <?PHP echo $thumbwidth ?> x <?PHP echo $thumbheight ?>) You may use the same image for both.</td>
		</tr>
		<tr>
...
function edititem ($id) {
    global $DB_site, $productpath, $picheight, $picwidth, $thumbheight, $thumbwidth, $dbprefix, $type;
	$temps=$DB_site->query("SELECT * FROM ".$dbprefix."items where itemid='$id'");
	while ($row=$DB_site->fetch_array($temps)) {
    ?>
	<b><font color="Navy">Edit Item:</font> <?PHP echo $id ?></b><br><br>
	<form action="admin.php?action=updateitem" method="post" enctype="multipart/form-data">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
	    <tr>
			<td bgcolor="Silver"><b>SKU#:</b> (Optional)</td>
			<td bgcolor="Silver"><input type="text" name="sku" size="25" value="<?PHP echo $row[sku]; ?>"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			while ($row1=$DB_site->fetch_array($temp1)) {
			     print("<option value=\"$row1[categoryid]\">".stripslashes($row1[title])."</option>"); 
			}
			?>
			</select>
			</td>
		...
		<tr>
			...
			while ($row1=$DB_site->fetch_array($temp1)) {
				 ...
				 $row2=$DB_site->fetch_array($temp2);
			     print("<option value=\"$row1[subcategoryid]\">".stripslashes($row2[title])." -> ".stripslashes($row1[title])."</option>"); 
			}
			?>
			</select>
			</td>
		...
		<tr>
			...
			<td bgcolor="Silver"><input type='text' name='title' size='30' value='<?PHP echo stripslashes($row[title]); ?>'></td>
		</tr>
		<tr>
			<td valign="top"><b>Image:</b></td>
			<td><input type="file" name="imagename" size="20" accept="image/jpeg,image/gif"><br>
				<img src="../<?PHP echo $productpath ?><?PHP echo $row[imagename] ?>" border="0" alt="" width="<?PHP echo $picwidth ?>" height="<?PHP echo $picheight ?>"><br><input type="checkbox" name="keepimage" value="1" checked>Keep Current Image
				<br>(Displays at <?PHP echo $picwidth ?> x <?PHP echo $picheight ?>)
			</td>
		</tr>
		<tr>
			<td valign="top" bgcolor="Silver"><b>Thumbnail:</b></td>
			<td bgcolor="Silver"><input type="file" name="thumb" size="20" accept="image/jpeg,image/gif"><br>
			    <img src="../<?PHP echo $productpath ?><?PHP echo $row[thumb] ?>" border="0" alt="" width="<?PHP echo $thumbwidth ?>" height="<?PHP echo $thumbheight ?>"><br><input type="checkbox" name="keepthumb" value="1" checked>Keep Current Image
...
// ##################### addoption #######################
function addoption () {
    global $cs, $DB_site, $dbprefix;;
	?>
	<div align="left"><b><font color="Navy">Add New Option</font></b><br><br>
	<form action="admin.php?action=storeoption" method="post">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
	    <tr>
			...
			$temp=$DB_site->query("SELECT * FROM ".$dbprefix."items ORDER by title");
			while ($row=$DB_site->fetch_array($temp)) {
				print("<option value=\"$row[itemid]\">".stripslashes($row[title])." - Product #$row[itemid]</option>");
			}
			print ("</select>");
			?>
			</td>
		...
		<tr>
			<td width="100" valign="top"><b>Option Name:</b></td>
			<td><input type="text" name="name" size="30" value="">
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Drop Down Items:</b></td>
			<td bgcolor="Silver"><input type="text" name="items" value="" size="30"><br>
			Seperate each option with "->"
			</td>
		</tr>
		<tr>
			<td width="100" valign="top"><b>Price Increase:</b></td>
			<td><input type="text" name="increase" value="" size="30"><br>
			Seperate each increase with "->". Leave blank if no increase.
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Option Order:</b></td>
			<td bgcolor="Silver"><input type="text" name="order" value="" size="3"></td>
		</tr>
		<tr>
			<td width="100">&nbsp;</td>
...
function editoption ($ID) {
	...
	?>
	<div align="left"><b><font color="Navy">Edit Option</font></b><br><br>
	<form action="admin.php?action=updateoption" method="post">
	<input type="hidden" name="id" value="<?PHP echo $ID ?>">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
	    <tr>
			<td valign="top" bgcolor="Silver" width="110"><b>Product:</b></td>
			<td bgcolor="Silver">
			<?PHP
			print ("<select name=\"itemid\">");
			$temp=$DB_site->query("SELECT * FROM ".$dbprefix."items ORDER by title");
			while ($row1=$DB_site->fetch_array($temp)) {
			    if ($row[productid] == $row1[itemid]) {
					print("<option value=\"$row1[itemid]\" selected>".stripslashes($row1[title])." - Product #$row1[itemid]</option>");
				} else {
					print("<option value=\"$row1[itemid]\">".stripslashes($row1[title])." - Product #$row1[itemid]</option>");
				}
			}
			print ("</select>");
			?>
		...
		<tr>
			<td width="100" valign="top"><b>Option Name:</b></td>
			<td><input type='text' name='name' size='30' value='<?PHP echo stripslashes($row[name]); ?>'>
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Drop Down Items:</b></td>
			<td bgcolor="Silver"><input type='text' name='items' size='30' value='<?PHP echo stripslashes($row[items]); ?>'><br>
			Seperate each option with "->"
			</td>
		</tr>
		<tr>
			<td width="100" valign="top"><b>Price Increase:</b></td>
			<td><input type="text" name="increase" size="30" value="<?PHP echo stripslashes($row[increase]); ?>"><br>
			Seperate each increase with "->". Leave blank if no increase.
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Option Order:</b></td>
			<td bgcolor="Silver"><input type="text" name="order" size="3" value="<?PHP echo stripslashes($row[order1]); ?>"></td>
		</tr>
		<tr>
			<td width="100">&nbsp;</td>
			<td><input type="submit" name="Submit" value="Edit Option">&nbsp;&nbsp;<input type="Reset"></td>
		</tr>
	</table>
	</div><br>	
	<?PHP
...
function addfield () {
    global $cs, $DB_site, $dbprefix;;
	?>
	<div align="left"><b><font color="Navy">Add New Custom Field</font></b><br><br>
	<form action="admin.php?action=storefield" method="post">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
	    <tr>
			<td valign="top" bgcolor="Silver" width="110"><b>Choose a Product:</b></td>
			<td bgcolor="Silver">
		...
		<tr>
			<td width="100" valign="top"><b>Field Name:</b></td>
			<td><input type="text" name="name" size="30" value="">
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Type:</b></td>
			<td bgcolor="Silver"><input type="radio" name="type" value="textbox" checked>Text Box&nbsp;&nbsp;<input type="radio" name="type" value="textarea">Text Area</td>
		</tr>
		<tr>
			<td width="100" valign="top"><b>Default Value:</b></td>
			<td><textarea cols="45" rows="10" name="default"></textarea>
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Field Order:</b></td>
			<td bgcolor="Silver"><input type="text" name="order" value="" size="3"></td>
		</tr>
		<tr>
			<td width="100">&nbsp;</td>
...
function editfield ($ID) {
	global $DB_site, $dbprefix;
	$temps=$DB_site->query("SELECT * FROM ".$dbprefix."itemfields where id='$ID'");
	$row=$DB_site->fetch_array($temps);
	?>
	<div align="left"><b><font color="Navy">Edit Custom Field</font></b><br><br>
	<form action="admin.php?action=updatefield" method="post">
	<input type="hidden" name="id" value="<?PHP echo $ID ?>">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
	    <tr>
			<td valign="top" bgcolor="Silver" width="110"><b>Product:</b></td>
		...
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Type:</b></td>
			<td bgcolor="Silver"><input type="radio" name="type" value="textbox" <?PHP if ($row[type] == "textbox") { echo "checked"; } ?>>Text Box&nbsp;&nbsp;<input type="radio" name="type" value="textarea" <?PHP if ($row[type] == "textarea") { echo "checked"; } ?>>Text Area</td>
		</tr>
		<tr>
			<td width="100" valign="top"><b>Default Value:</b></td>
			<td><textarea cols="45" rows="10" name="default"><?PHP echo stripslashes($row[defaultv]); ?></textarea>
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Option Order:</b></td>
		...
		<tr>
			<td width="100">&nbsp;</td>
			<td><input type="submit" name="Submit" value="Edit Field">&nbsp;&nbsp;<input type="Reset"></td>
		</tr>
	</table>
	</div><br>	
	<?PHP
...
function edittemplate ($ID) {
	global $DB_site, $dbprefix;
	$temps=$DB_site->query("SELECT * FROM ".$dbprefix."templates where id='$ID'");
	while ($row=$DB_site->fetch_array($temps)) {
	?>
	<div align="left"><b><font color="Navy">Edit Template ID:</font> <?PHP echo $ID ?></b><br><br>
	<form action="admin.php?action=updatetemplate" method="post">
	<input type="hidden" name="id" value="<?PHP echo $ID ?>">
   	<table width="95%" border="0" cellspacing="2" cellpadding="3">
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Template:</b></td>
			<td bgcolor="Silver">
			<textarea cols="55" rows="20" name="template" wrap="off"><?PHP echo stripslashes(stripslashes(stripslashes($row[template]))); ?></textarea>
			</td>
		</tr>
		<tr>
...
function adddiscount () {
    global $cs, $DB_site, $dbprefix;
	?>
	<div align="left"><b><font color="Navy">Add New Discount</font></b><br><br>
	<form action="admin.php?action=storediscount" method="post">
	<table width="95%" border="0" cellspacing="2" cellpadding="3">
		<tr>
			<td valign="top" bgcolor="Silver" width="110"><b>Choose a Product:</b></td>
			<td bgcolor="Silver">
		...
		<tr>
			<td width="100" valign="top"><b>Discount/Free Amount:</b></td>
			<td><input type="text" name="discount" value="" size="5"><br>
			For percentage use decimal. (i.e. 50% = .50)
			</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Type:</b></td>
			<td bgcolor="Silver"><input type="radio" name="type" value="D" checked>Dollar Ammount<input type="radio" name="type" value="P">Percentage<input type="radio" name="type" value="F">Get Above Quantity Free<br>
			</td>
		</tr>
		<tr>
			<td width="100" valign="top"><b>Purchase Quantity:</b></td>
			<td>From:<input type="text" name="frombuy" size="4"> To:<input type="text" name="tobuy" size="4"></td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Activated:</b></td>
			<td bgcolor="Silver"><input type="radio" name="displayit" value="Y" checked>Yes&nbsp;&nbsp;<input type="radio" name="displayit" value="N">No</td>
		</tr>
		<tr>
			<td width="100" valign="top"><b>Message:</b></td>
			<td><textarea cols="40" rows="5" name="message"></textarea><br>
			Describe the item discount.</td>
		</tr>
		<tr>
			<td width="100" bgcolor="Silver">&nbsp;</td>
...
function editdiscount ($ID) {
	global $DB_site, $dbprefix;
	$temps=$DB_site->query("SELECT * FROM ".$dbprefix."discounts where id='$ID'");
	while ($row=$DB_site->fetch_array($temps)) {
	?>
	<div align="left"><b><font color="Navy">Edit Discount ID:</font> <?PHP echo $ID ?></b><br><br>
	<form action="admin.php?action=updatediscount" method="post">
	<input type="hidden" name="id" value="<?PHP echo $ID ?>">
   	<table width="95%" border="0" cellspacing="2" cellpadding="3">
		<tr>
			<td valign="top" bgcolor="Silver" width="110"><b>Product:</b></td>
		...
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Type:</b></td>
			<td bgcolor="Silver"><input type="radio" name="type" value="D" <?PHP if ($row[type] == "D") { print("checked"); } ?>>Dollar Ammount<input type="radio" name="type" value="P" <?PHP if ($row[type] == "P") { print("checked"); } ?>>Percentage<input type="radio" name="type" value="F" <?PHP if ($row[type] == "F") { print("checked"); } ?>>Get Above Quantity Free<br>
			</td>
		</tr>
		<tr>
			<td width="100" valign="top"><b>Purchase Quantity:</b></td>
			<td>From:<input type="text" name="frombuy" size="4" value="<?PHP echo $row[frombuy] ?>"> To:<input type="text" name="tobuy" size="4" value="<?PHP echo $row[tobuy] ?>"></td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Activated:</b></td>
			<td bgcolor="Silver"><input type="radio" name="displayit" value="Y" <?PHP if ($row[displayit] == "Y") { print("checked"); } ?>>Yes&nbsp;&nbsp;<input type="radio" name="displayit" value="N" <?PHP if ($row[displayit] == "N") { print("checked"); } ?>>No</td>
		</tr>
		<tr>
			<td width="100" valign="top"><b>Message:</b></td>
			<td><textarea cols="40" rows="5" name="message"><?PHP echo stripslashes($row[message]) ?></textarea><br>
			Describe the item discount.</td>
		</tr>
		<tr>
			<td width="100" valign="top" bgcolor="Silver"><b>Sold:</b></td>
			<td bgcolor="Silver"><?PHP echo $row[sold] ?></td>
		</tr>
		<tr>
			<td width="100">&nbsp;</td>
			<td><input type="submit" name="Submit" value="Continue">&nbsp;&nbsp;<input type="Reset"></td>
...
function gettracking ($ID, $num) {
	...
	while ($row=$DB_site->fetch_array($temp)) {
	    if ($num == 1) {
			...
			$number = stripslashes($row[carrier]);
		}
	}
	echo $number;
}
...
function viewtransaction ($ID) {
	...
	while ($row=$DB_site->fetch_array($temps)) {
		$iarray = parseit ($row[items]);
		$qarray = parseit ($row[itemquantity]);
		$oarray = parseit ($row[options]);
		$parray = parseit ($row[prices]);
		$farray = parseit ($row[ofields]);
	...
	<table>
		...
		<tr>
			<td><b>Tracking Number: (Optional)</b></td>
			<td><input type="text" name="tracking" value="<?PHP gettracking($ID, 1); ?>"></td>
		</tr>
		<tr>
			<td><b>Shipping Service: (Optional)</b></td>
			<td><select name="carrier"><option value="<?PHP gettracking($ID, 2); ?>"><?PHP gettracking($ID, 2); ?><option value="UPS">UPS<option value="USPS">USPS<option value="Federal Express">Federal Express</select></td>
		</tr>
		<tr>
			...
			<td>
				<table width="100%" border="1" cellspacing="0" cellpadding="5">
					...
					for ($i = 0 ; $i < $num ; $i++) { 
						...
						print ("
						<tr>
							<td valign=\"top\">$iteminfo[num]</td>
							<td valign=\"top\">$iteminfo[title]</td>
							<td valign=\"top\">$qarray[$i]</td>
							<td valign=\"top\">$oarray[$i]");
						$custom = explode("||", $farray[$i]);
						for ($j = 0; $j < count($custom); $j++) {
							if ($custom[$j] != "") {
								$put = explode("::", $custom[$j]);
								echo "<br><strong>".stripslashes($put[0])."</strong>: ".stripslashes($put[1]);
							} 
						}	
						print("</td>
							<td valign=\"top\">$parray[$i]</td>
						</tr>
						");
					}
					?>
	...
	<table>
		...
		<tr>
			...
			<td><?PHP echo decryptit($row[card_no]); ?>
			</td>
		</tr>
		<tr>
...
function showpl ($ID) {
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<tr>
			...
			<td><?PHP echo $cs.$row[total]; ?></td>
		</tr>
	</table><br>
	*Total reflects applicable taxes, shipping charges and coupons used.<br><br>
	Thank you for shopping at <?PHP echo $title; ?>... visit us again soon.<br>
	<?PHP echo $shopurl; ?>
	<?PHP
	}
	exit;
...
function deletetransaction($id) {
	...
	while ($row=$DB_site->fetch_array($temp)) {
		$DB_site->query("DELETE FROM ".$dbprefix."user where userid='$row[userid]' AND username like '%TempAccount%'");
	}
	$DB_site->query("DELETE from ".$dbprefix."tracking where tranid='$id'");
