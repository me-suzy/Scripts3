<html>
<head>
<title>SunShop : Turnkey Web Tools</title>
...
<div align="center">
  ...
  <table border="0" width="400">
    ...
    <tr>
      <td width="100%">
        <p align="center"><b><font face="Verdana,Arial" size="1">Developed By <!-- CyKuH [WTN] -->Turnkey Web Tools</font></b></td>
    </tr>
    <tr>
      <td width="100%">
    ...
    <tr>
      <td width="100%"><b><font face="Verdana,Arial" size="2" color="#7B2418">Instruction:<br>
        </font></b><font face="Verdana,Arial" size="2" color="#000000">Please login using your login administration information. *IMOPORTANT* When viewing your customers credit card information it is important that you connect securely. If your server supports it you may do this by replacing http:// with https:// in the address.</font><b></b></td>
    </tr>
  </table>
  </center>
</div>
