...
<center><img src="images/triviashock_light.gif">
...
<tr><td bgcolor="#341688" width="100%">

<table cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td bgcolor="#184A9C" align=center width="100%">
<b><font size=4 face="verdana,arial,tahoma,helvetica" color="#FFFFFF">

TriviaShock <?php echo TS_VERSION;?>  Nullified Installation
<tr><td bgcolor="#eeeeee" align=center width="100%">
<font size=2 face="arial,tahoma,helvetica">
	Thanks CyKuH and Stive in WTN Team. 
</font>
</td></tr>
...
if( !$step )
{
	?>
	<blockquote>
	Welcome. This program will install TriviaShock <?php echo TS_VERSION;?> on your web site.
...
elseif( $step == 4 )
{
	...
	$queries = @file("inc/triviashock.sql");
...
elseif( $step == 6 )
{
	...
	else
	{
		...
		{
			$db->query("UPDATE $DB_TABLES[USERS] SET password='" . md5($HTTP_POST_VARS['admin_password']) . "', date_registered=" . time() . " WHERE id=1 AND username='admin'");
...
elseif( $step == 7 )
{
	...
	$db->query("UPDATE $DB_TABLES[OPTIONS] SET the_value='$trivia_site_url' WHERE the_key='TRIVIA_SITE_URL'");
