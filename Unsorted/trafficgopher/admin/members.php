...
?>
<table width="420" cellspacing="0" style="border: 1 solid #000000" align="center">
	<td width="50">
	  <div class="text" align="center">&nbsp;</div>
	</td>
	<td width="100">
	  <div class="text" align="center">First Name</div>
	</td>
	<td width="100">
	  <div class="text" align="center">Last Name</div>
	</td>
	<td width="100">
	  <div class="text" align="center">Username</div>
	</td>
	<td width="70">
	  <div class="text" align="center">Status</div>
	</td>
  </tr>
  <?php
	...
	if($numrows > 0)
	{
		...
		print "<tr><td  colspan=6><div align='center'><a href='javascript:selectAll()'>Select All</a>&nbsp;|&nbsp;<a href='javascript:clearAll()'>Clear All</a>&nbsp;|&nbsp;<a href='javascript:deleteAll()'><font size=3>Delete</font></a>&nbsp;|&nbsp;<a href='javascript:editAll()'>Edit</a></div></td></tr>";
		print "</form>";
	}
	else
	{
