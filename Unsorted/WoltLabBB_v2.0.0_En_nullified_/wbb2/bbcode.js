...
link_text_prompt = "Enter the name of the link (optional)";
link_url_prompt = "Enter the complete URL of the link";
link_email_prompt = "Enter the email address";
list_type_prompt = "What type of list do you want? Enter '1' for a numbered list, 'a' for an alphabetical list or leave the field empty for a normal bullet list.";
list_item_prompt = "Enter a list item.\nLeave the field empty or press 'Cancel' to compile/finish the list.";
// *******************************************************
