...
if($action == "view") {
 ...
 switch($_REQUEST['sortby']){
  ...
  DEFAULT: $where = "WHERE a.userid = 0"; break;
 }
 ...
 if($pages > 1) $pagelink = makeadminpagelink("avatar.php?action=view&sid=$session[hash]&sortby=$sortby&orderby=$orderby",$page,$pages,2);
...
if($action=="readfolder") {
 if(isset($_POST['send'])) {
  ...
  if(is_dir($avatarfolder) && $avatarfolder!="../images/avatars" && $avatarfolder!="../images/avatars/") {
