...
} elseif ($delete) { // IF DELETE IS CLICKED
...
include ("../../emails/cancelorder.inc");
...
// ----------------------------------------------- END IF DELETE IS CLICKED ---------------------------------------------------------------

} elseif ($id) { // IF PENDING CLIENT IS SELECTED, SHOW CLIENT DETAILS

include ("$rootdirectory/admin/clientmanager/readpendingclients.inc");
...
include ("../../templates/$template/admin/clientmanager/activate.inc");
