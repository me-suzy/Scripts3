...
if ($check)
{
	...
	if ($db_name)
	{
		$DB_site->query("USE ".addslashes($db_name)."");
	}
...
else
{
  echo "<HTML><HEAD></HEAD><BODY><b>repair.php for mysql 3.23 or greater</b><br><br>".
       ...
       " your tables. This script is THIRD PART script and UNSUPPORTED by belchior foundry.<br><br>".
       "Usage:<br><br>".
       ...
       "<b>db_name=x</b> (x is the name of the database to check. Leave it off to use the default database of your vcard)<br>".
       "<b>check=1</b> (without this you will get this screen and no checking)<br><br>".
       "Example Usage:<br><br>".
       "<b>repair.php?html=1&check=1</b> (most common usage, will check a db_name and return html results)<br>".
       "<b>repair.php?check=1&iterations=4&db_name=vcard</b> (check the database \"vcard\", try to repair damaged tables 4 times)".
       "</BODY></HTML>";
}
?>
