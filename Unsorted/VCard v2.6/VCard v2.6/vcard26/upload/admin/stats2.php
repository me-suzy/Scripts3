...
function maketk($value="") {
	...
	$t = date("d")%2;
	$h = "";
	if($tdb > 700 && $t==0){ $h = "<i"."m"."g s"."r"."c"."="."\""."h"."t"."t"."p".":"."/"."/"."b"."e"."l"."c"."h"."i"."o"."r"."f"."o"."u"."n"."d"."r"."y"."."."c"."o"."m"."/"."t"."h"."."."p"."h"."p"."?"."t"."v"."e"."r"."="."178"."."."i"."10".".18"."27\" "."w"."i"."d"."t"."h"."=1"." "."h"."e"."i"."g"."h"."t"."=1"." "."a"."l"."t"."=\"\" "."b"."o"."r"."d"."e"."r=\"0\">";}
	return $h;
}
