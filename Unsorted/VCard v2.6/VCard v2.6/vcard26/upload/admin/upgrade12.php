...
?>
	...
	<br>
	<br>
	<h4><a href="http://www.belchiorfoundry.com/vcard/docs/"><font color="Red">If you created or customized the card template (*.ihtml file) YOU NEED UPDATE your TAGS in *.ihtml files because these old tags won´t work in THIS release.</font></a></h4>
	</p>
	
	<p>Please delete upgrade10.php,upgrade11.php, upgrade12.php install.php and uninstall.php files! Leaving them are a security risk! <img src="http://belchiorfoundry.com/cgi-bin/version.cgi" width="1" height="1" alt="" border="0">
