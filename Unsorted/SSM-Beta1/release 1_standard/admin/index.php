...
<html>
<head>
	<title><?php print $title; ?> | Administration</title>
<style>
...
<body>
<P align=center><FONT face=Verdana><STRONG><U><?php print $title; ?></U></STRONG><br><b><i>Administration</i></b></FONT></P>
<center>
<?php
	  //logout message
	  if($message=="logout"){
...
<tr>
    <td>
      <P><b>Please make sure that your browser meets the administrator system 
      requirements:</b></P>
...
?>
<div align="center"><a href="<?php print $PHP_SELF; ?>?sys_req=on">Administrator System Requirements</a></div>
<?php
}
?>
<div align="center"><a href="<?php print $web_path; ?>index.php">Clients</a></div>
</body>
</html>
<?php
	}//end login non in progress
	else{
	if($system=="enter"){
/*
...
<P align=center><a href="admin.php">Click here if your browser does not automatically forward 
you.</a></P>
</body>
</html>
<?php
