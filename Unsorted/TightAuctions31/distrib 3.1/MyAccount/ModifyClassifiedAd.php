<?
   ...
   include( "../dblink.inc" );
	...
	$query = "SELECT Title, Price, Description, CatID, Quantity FROM Ads WHERE UserAcctID=$UserAcctID AND AdID=$AdID";
...
function previewAd()
{
	var winNewAd = window.open("../viewad.php?AdID=" + <? echo $AdID; ?> + "&mode=preview", "previewAd", "width=750,height=450, scrollbars=yes, resizable=yes");	
	winNewAd.focus();
}

function updateAd()
{
	document.SubmitModifyAd.action="ModifyClassifiedAd.php?action=update";
...
function disableAd()
{
    ...
    {
		document.SubmitModifyAd.action="SubmitModifyClassifiedAd.php?action=disable";
		document.SubmitModifyAd.submit();
	}
}
...
function renewAd()
{
    ...
    {
		document.SubmitModifyAd.action="SubmitModifyClassifiedAd.php?action=renew";
		document.SubmitModifyAd.submit();
	}
}
...
function deleteAd()
{
    ...
    {
		document.SubmitModifyAd.action="SubmitModifyClassifiedAd.php?action=delete";
		document.SubmitModifyAd.submit();
	}
}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="*"><font face="Arial, Helvetica, sans-serif" size="3"><b><font size="4" color="#003399">Modify 
            Classified Ad</font></b></font></td>
        </tr>
        <tr> 
          <td width="30">&nbsp;</td>
          <td width="*"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><br>
            Update, renew, disable, or delete your classified ad. </font></td>
        </tr>
        <tr> 
          <td width="30">&nbsp;</td>
          <td width="*"> <br>
<?
	if ($action == "update")
	{
		...
		else
		{
			...
			$query = "UPDATE Ads SET CatID=$Category, Title='$Title2', Price='$Price2', Quantity='$Quantity2', Description='$Description2', ModifiedIPAddress='$IP'";
...
<br>
<form action="SubmitModifyClassifiedAd.php" method="post" name="SubmitModifyAd">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <tr> 
            ...
            <td><b><font face="Arial, Helvetica, sans-serif">Price </font></b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">(Enter 
              the price of your product below.)</font><font face="Arial, Helvetica, sans-serif" size="1"> 
              </font></td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
...
?> 
          ...
          <tr> 
            <td>&nbsp;</td>
            <td><a href="javascript:renewAd();"><font face="Arial, Helvetica, sans-serif"><b><font size="2"><font size="3">Renew 
          ...
          <tr> 
            <td>&nbsp;</td>
            <td><a href="MyAccount.php"><font face="Arial, Helvetica, sans-serif"><b><font size="2"><font size="3">Go 
              Back to My Accounts</font></font></b></font></a> </td>
          </tr>
        </table>
</form>
    </td>
