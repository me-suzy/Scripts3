...
if ($_POST["addtrade"] != "" AND $webmasterpage != 2 AND $max_trades > $total_trades) {
	...
	if ($_POST["wm_email"] == "") { $msg[] = "Enter an email address"; }
		...
		if ($onlyfindtrades == 1) {
			$findtrades = @implode("",@file("http://www.findtrades.com/ttt.php?d=$_sitedomain"));
			if ($findtrades == "0") { $msg[] = "You are not in findtrades.com's database<br>You need to add your site before you can trade with this site<br>Go to <a href='http://www.findtrades.com/'>http://www.findtrades.com/</a>"; }
		}
	}
...
<table width="500" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td height="28" align="center" background="tttadmin/background.gif"><a href="http://www.turbotraffictrader.com/"><img src="tttadmin/ttt.gif" width="160" height="20" border="0"></a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="normalrow"><iframe src="http://www.turbotraffictrader.com/iframe2.htm" width="480" marginwidth="0" height="160" marginheight="0" scrolling="auto" border"0" frameborder="0"></iframe></td>
  </tr>
  <tr>
