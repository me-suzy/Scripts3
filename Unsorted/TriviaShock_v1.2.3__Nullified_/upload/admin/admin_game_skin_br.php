...
show_cp_header();
show_section_info("Browse Game Skins", "View samples of each Flash 5 Game Skin. Game Skins control the look of the game frontend.");
...
function show_form()
{
	...
	start_form_table();
	do_table_header("<b>Select Game Skin</b>", 2);
	
	$currbg = switch_bgcolor($currbg);
	start_table_row();
	do_option_info_cell("Game Skin File", "Select the game skin to display.", $currbg);
	...
	do_submitbutton("form_options[submit]", "View Game Skin");
	end_table_cell();
	end_table_row();
