...
?>
	...
	<h4><!--CyKuH [WTN]-->If you created or customized the card template (*.ihtml file) YOU NEED UPDATE your TAGS in *.ihtml files because these old tags won´t work in THIS release.</h4>
	</p>
	
	<p>Please delete upgrade10.php,upgrade11.php, install.php and uninstall.php files! Leaving them are a security risk!<!--CyKuH [WTN]-->
