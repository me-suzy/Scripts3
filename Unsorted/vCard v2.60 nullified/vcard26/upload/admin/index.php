...
if($action=='m')
{
	dothml_pageheader();
?>
<div align="center"><a href="../" target="_blank" onMouseOver="window.status=' Powered by vCard ';return true" onMouseOut="window.status='';return true"><img src="../img/icon_powered.gif" alt="" border="0"></a><!--CyKuH [WTN]--></div>
<p>
...
<?php
dothml_local_titlelabel($msg_admin_nullification,"","",$vcuser['superuser']);
?>
<tr>
	<td>
|<a href="<?php echo "nullification.php?action=&s=$s"; ?>" target="main"><?php echo "$msg_admin_extrainfo"; ?></a>|
	</td>
</tr>
<?php
