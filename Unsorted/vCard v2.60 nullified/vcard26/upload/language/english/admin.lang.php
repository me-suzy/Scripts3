<?php
/* ############################################### ADIM PAGES TEXTS ##################################################### */
/* You can Leave the admin section in english to less translation */
...
$msg_admin_avaiableversion = 'Available version';
...
$msg_admin_stat_note = 'If you like to restart the Statistics you are free to do so by pushing this button. Consider however that all your current statistics information will be deleted. In order to keep that information as a history file save your current reports to your own harddisk first or print this page.';
...
$msg_admin_emillog_note = 'If you like to restart the Email Log you are free to do so by pushing this button. Consider however that all your current information will be deleted. In order to keep that information as a history file save your current reports to your own harddisk first.';
...
$msg_admin_search_reindexnote = 'the database reindex may take some time. But is a required action if you note some error in your search function or you are upgrading from previous version.';
...
$msg_admin_stat_chartnote = 'ONLY IF you server has <b>the GD lib module</b> corrected installed with your PHP you are able too see this image! You can ask to your ISP install this module in your PHP server!<p>';
...
$msg_admin_stat3_note = 'If you like to restart the <b>Statistics of EXTERNAL FILES ONLY</b> you are free to do so by pushing this button. Consider however that all your current statistics information will be deleted. In order to keep that information as a history file save your current reports to your own harddisk first or print this page.';
$msg_admin_stat4_note = 'If you like to restart the <b>Rating Sytem ONLY</b> you are free to do so by pushing this button. Consider however that all your current statistics information will be deleted. In order to keep that information as a history file save your current reports to your own harddisk first or print this page.';
...
$msg_admin_optimize_note = 'This tool is only to optimize MySQL (mysql 3.23 or greater) database because';
...
$msg_admin_cache_note = 'If you set vCard Cache = YES you will need update every time the vCard cache to reflect the changes that you make in your templates.';
// updated:
...
/* added version 2.4 */
$msg_admin_poem_style = 'Did you are including HTML code?';
$msg_admin_poem_note_style = 'If NO vcard will formate you text. If YES you can add your poem with HTML/Javascript code';
...
$msg_admin_dbbkp_dumpviaweb = 'From here you will download the MySQL dump file to your computer';
$msg_admin_dbbkp_sucessfully = 'Data dumped sucessfully!';

/* added version 2.6 by CyKuH */
...
$setting_description['vcardactive'] = 'From time to time, you may want to turn your vcard off to the public while you perform maintenance, update versions, etc. When you turn your vCard off, visitors will receive a message that states that the vCard is temporarily unavailable. <br>The page with unavaiable message can be found in templates > unavaiablepage.';
...
$setting_description['user_rating_allow'] = 'Allow rating system avaiable to end-user?';
