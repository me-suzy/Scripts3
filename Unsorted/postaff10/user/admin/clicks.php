<?
  ...
  include "header.php"; 
?>  
  <form method=post action=changeclick.php>
    <table border=0 cellspacing=0 cellpadding=0>
    <tr align=center valign=middle> 
      <td width=200><font face=Arial, Helvetica, sans-serif><?=AFF_C_SHOWCLICKSFOR?></font></td>
       <td width=70> 
         <select name=change>";
<?          
...
<?    	
  $result = mysql_db_query($database, "select * from clickthroughs ORDER BY date and time LIMIT 19") 
    or die ("Database Error"); 
		
  print "<br><br><font face=arial>Last 20 Clickthroughs To Your Site: ".mysql_num_rows($result)."<br><br>";
