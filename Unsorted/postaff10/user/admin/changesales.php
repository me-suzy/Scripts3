...
<?    	
  ...
  $result = mysql_db_query($database, "select * from sales where refid = '$change' ORDER BY date and time") 
    or die ("Database Error"); 
		
  print "<br><br><font face=arial>".AFF_S_SALESFROM.": ".$change." ".AFF_S_FORSITE.": ".mysql_num_rows($result)."<br><br>";
     
  if (mysql_num_rows($result)) 
  {
    print "<font face=arial><TABLE border=1 cellspacing=0 cellpadding=3>";
    print "<TR><TH>".AFF_G_DATE."</TH><TH>".AFF_G_TIME."</TH>";
    print "<TH>".AFF_G_EARNINGS."</TH></TR>";
