...
<BODY leftMargin=0 topMargin=0>
  ...
  <tr valign="top" height="62"> 
    ...
    <tr> 
      <td colspan=2 bgcolor="#006699" height="34">&nbsp;&nbsp;<span class=peheader><i>POST Affiliate 1.0</i></span></td> 
    </tr> 
    <tr> 
       <td bgcolor="#6699CC">
<? if(aff_check_security()) { ?>
       &nbsp;
       <a class="headLink" href=details.php><?=AFF_M_CHANGEDETAILS?></a>
       &nbsp;|&nbsp;
       ...
       &nbsp;|&nbsp;
    	 <a class="headLink" href=contact.php><?=AFF_M_CONTACT?></a>
<?  } ?>
      </td> 
