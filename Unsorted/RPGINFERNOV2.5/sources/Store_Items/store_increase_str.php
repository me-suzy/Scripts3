...
var $name="Increase STR";
var $descr="Increase's Current STR By 50";
...
$member['str']=($member['str']+50);
$DB->query("update ibf_members set str='{$member['str']}',money=money-'{$itemx['cost']}' where id='{$ibforums->member['id']}'");
$DB->query("update ibf_infernostore set stock=stock-'1' where id='{$item['id']}'");
$print->redirect_screen("You now have ".$member['str']." STR", "act=RPG&CODE=Store",0);
}
