<?php echo"\n\n";?>
<!-- START of countries.php -->
<select name='ycountry' class="input">
<?php print("<option value='$ycountry' SELECTED>$ycountry</option>");?>
...
<option  value='Ashmore and Cartier Islands'>Ashmore Islands</option>
...
<option  value='British Indian Ocean Territory'>B.I.O.Territory</option>
...
<option  value='Norther Mariana Islands'>N. Mariana Is.</option>
...
<option  value='Serbia and Montenegro'>Serbia - Montenegro</option>
