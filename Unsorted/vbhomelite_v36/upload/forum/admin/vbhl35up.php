...
echo "Once the upgrade completed, you will need to reupload the vbHome (lite) core files onto your server and set again your vbHome Options, since they are reset to default values.<br>\n";
...
echo "<td>\n";
  ...
  if ($DB_site->errno != 0) {
    ...
    echo "<p>New options set successfully.</p><p></td>\n";
  }
