...
class DB_Sql_vb {
  ...
  var $appname  = "SunShop Shopping Cart";
  var $appshortname = "SunShop";

  var $technicalemail = "support@mydomain.com";
  ...
  function halt($msg) {
    ...
    if ($this->reporterror==1) {
      ...
      @mail ($this->technicalemail,"$this->appshortname Database error!",$message,"From: $this->technicalemail");
      ...
      echo "An E-Mail has been dispatched to our <a href=\"mailto:$this->technicalemail\">Technical Staff</a>, who you can also contact if the problem persists.</p>";
