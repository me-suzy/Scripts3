...
<table width="500" border="1" cellpadding="3" cellspacing="2" bordercolor="#000000" bgcolor="#E4E4E4">
        ...
        <tr> 
          <td background="background.gif" colspan="2" class="toprows">Edit Blacklist</td>
        </tr>
        <tr class="normalrow"> 
...
<table  width="100%" border="1" cellpadding="3" cellspacing="2" bordercolor="#000000" bgcolor="#E4E4E4" align="center">
        ...
        <tr> 
          <td background="background.gif" colspan="2" class="toprows">Add New Site To Blacklist</td>
        </tr>
        <tr class="normalrow"> 
...
<table width="550" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td>
<table  width="100%" border="1" cellpadding="3" cellspacing="2" bordercolor="#000000" bgcolor="#E4E4E4" align="center">
 <tr class="toprows"> 
          <td background="background.gif" width="25%">Site Domain</td>
          <td background="background.gif" width="25%">Email</td>
          <td background="background.gif" width="15%">ICQ</td>
          <td background="background.gif" width="35%">Reason</td>
