...
$res = mysql_query("SELECT referer, hits FROM ttt_referers WHERE trade_id=$_GET[id] ORDER BY $orderby DESC LIMIT 100") or print_error(mysql_error());
close_conn();
...
<table border="0" cellspacing="0" cellpadding="1" align="center">
  ...
  <tr> 
    <td colspan="4" align="center"><font size="1"><strong><font size="2">Top 100 Refering URLs</font></strong></font></td>
  </tr>
  <tr> 
    <td colspan="4">&nbsp;</td>
  </tr>
  <tr> 
    <td colspan="4">
<table width="500" border="1" cellpadding="3" cellspacing="2" bordercolor="#000000" bgcolor="#E4E4E4">
<tr class="toprows">
	<td background="background.gif"><b><a target=_top href="?orderby=hits&id=<? echo $id ?>" title="Sort By Hits">Hits</a></b></td>
	<td background="background.gif" width="100%"><b><a target=_top href="?orderby=referer&id=<? echo $id ?>" title="Sort By IP">Referer</a></b></td>
</tr>
...
//	echo "$hits - <a href=\"$url\" title=\"$url\" target=\"_blank\">$referer</a><br>";
	...
	echo "<tr class=\"normalrow\"> <td>$hits</td>";
	echo "<td width=\"100%\" align=\"left\"><a href=\"$url\" title=\"$url\" target=\"_blank\">$referer</a></td></tr>";
}
mysql_free_result($res);
?>
