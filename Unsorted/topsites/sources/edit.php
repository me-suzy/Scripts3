...
elseif ($FORM['do'] == "submit") {
  ...
  if ($FORM['password'] == $password) {
    ...
    if ($error_url || $error_email || $error_title || $error_urlbanner) {
      $TMPL['content'] .= $LNG['edit_error']."<br /><br />\n";
      $TMPL['content'] .= $LNG['edit_error_forgot']."<br />\n";
      if ($error_url) { $TMPL['content'] .= $LNG['edit_error_url']."<br />"; }
      if ($error_email) { $TMPL['content'] .= $LNG['edit_error_email']."<br />"; }
      if ($error_title) { $TMPL['content'] .= $LNG['edit_error_title']."<br />"; }
      if ($error_password) { $TMPL['content'] .= $LNG['edit_error_password']."<br />"; }
