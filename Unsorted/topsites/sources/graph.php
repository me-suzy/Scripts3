...
$result = mysql_query("SELECT id, url, title, description, urlbanner, ".$FORM['type']."_today, ".$FORM['type']."_1, ".$FORM['type']."_2, ".$FORM['type']."_3, (".$FORM['type']."_today + ".$FORM['type']."_1 + ".$FORM['type']."_2 + ".$FORM['type']."_3) / 4
                       FROM ".$CONFIG['sql_prefix']."_members, ".$CONFIG['sql_prefix']."_stats
                       WHERE id = id2 AND id = ".$FORM['id']."
                       LIMIT 1");
$TMPL['queries']++;

list($TMPL['id'], $TMPL['real_url'], $TMPL['title'], $TMPL['description'], $TMPL['urlbanner'], $TMPL['tod_graph'], $TMPL['1_graph'], $TMPL['2_graph'], $TMPL['3_graph'], $TMPL['avg_graph']) = mysql_fetch_array($result, MYSQL_NUM);
