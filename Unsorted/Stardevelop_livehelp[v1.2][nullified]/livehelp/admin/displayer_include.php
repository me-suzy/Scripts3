...
?>
    ...
    <tr>
      <td> <div align="left"><font size="<?php echo($font_size); ?>" color="<?php echo($sent_font_color); ?>"  face="Verdana, Arial, Helvetica, sans-serif">
    <strong>[<?php echo($row['message_time']); ?>] <?php echo($row['from_username']); ?></strong>: <?php echo($displayMessage); ?><br>
    	</font></div></td>
    </tr>
    </table>
<?php
...
?>
    <table width="450" border="0" align="center">
    <tr>
      <td> <div align="left"><font size="<?php echo($font_size); ?>" color="<?php echo($received_font_color); ?>"  face="Verdana, Arial, Helvetica, sans-serif">
    <strong>[<?php echo($row['message_time']); ?>] <?php echo($row['from_username']); ?></strong>: <?php echo($displayMessage); ?><br>
    	</font></div></td>
    </tr>
    </table>
