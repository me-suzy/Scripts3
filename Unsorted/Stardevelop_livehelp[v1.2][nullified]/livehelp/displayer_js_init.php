...
<script language="JavaScript">
<!--
writeMessage('<table width="100%" border="0" align="center"><tr><td><div align="left"><font size="<?php echo($guest_chat_font_size); ?>" color="<?php echo($sent_font_color); ?>" face="<?php echo($font_type); ?>"><strong>[<?php echo($row['message_time']); ?>] <?php echo($row['from_username']); ?></strong>: <?php echo($displayMessage); ?><br></font></div></td></tr></table>');
rescroll();
//-->
</script>
<?php
...
<script language="JavaScript">
<!--
writeMessage('<table width="100%" border="0" align="center"><tr><td><div align="left"><font size="<?php echo($guest_chat_font_size); ?>" color="<?php echo($received_font_color); ?>" face="<?php echo($font_type); ?>"><strong>[<?php echo($row['message_time']); ?>] <?php echo($row['from_username']); ?></strong>: <?php echo($displayMessage); ?><br></font></div></td></tr></table>');
rescroll();
//-->
</script>
<?php
...
<!--
parent.displayRefreshFrame.location.href = 'displayer_js_refresher.php?<?php echo(SID); ?>&USER=<?php echo($support_username); ?>&LOGIN_ID=<?php echo($support_login_id); ?>';
//-->
</script>
</body>
</html>