...
echo "<td width='41%'><select size='1' value='$currency' name='currencyNew'>  <option value='$currency'>$currency</option>  <option value='£'>£</option>    <option value='Ðóá'>Ðóá</option>  <option value='$'>$</option>  <option value=''></option></select></td>\n";
echo "</tr>\n";
echo "<tr>\n";
...
echo "</div>\n";
echo "</form>\n";
echo "<p align=center><!--CyKuH [WTN]--><font face=Verdana size=2>Proceed to Main Menu? <a href=\"main.php\">Click Here</a></font></p>\n";
?>
<?pageFooter();?>