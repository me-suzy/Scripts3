<?php
/* -----------------------------------------------------------------------------------------
   $Id: account_newsletters.php,v 1.1 2003/09/06 21:38:27 fanta2k Exp $   
...
// needs to be included earlier to set the success message in the messageStack
  ...
  $breadcrumb->add(NAVBAR_TITLE_2, xtc_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL'));
?>
...
<!-- body_text //-->
    <td class="tableBody" width="100%" valign="top"><?php echo xtc_draw_form('account_newsletter', xtc_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL')) . xtc_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
              ...
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr class="moduleRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="checkBox('newsletter_general')">
                    <td class="main"><?php echo xtc_draw_checkbox_field('newsletter_general', '1', (($newsletter['customers_newsletter'] == '1') ? true : false), 'onclick="checkBox(\'newsletter_general\')"'); ?></td>
