<?php
/* -----------------------------------------------------------------------------------------
   $Id: create_guest_account.php,v 1.1 2003/09/06 21:38:27 fanta2k Exp $
...
require_once('inc/xtc_draw_radio_field.inc.php');
require_once('inc/xtc_get_country_list.inc.php');
require_once('inc/xtc_get_countries.inc.php');
require_once('inc/xtc_draw_checkbox_field.inc.php');
require_once('inc/xtc_draw_password_field.inc.php');
require_once('inc/xtc_validate_email.inc.php');
require_once('inc/xtc_encrypt_password.inc.php');
require_once(DIR_WS_CLASSES.'class.phpmailer.php');
require_once('inc/xtc_php_mail.inc.php');
require_once('inc/xtc_create_password.inc.php');
...
// restore cart contents
  ...
  $breadcrumb->add(NAVBAR_TITLE, xtc_href_link(FILENAME_CREATE_GUEST_ACCOUNT, '', 'SSL'));
?>
...
<!-- body_text //-->
    <td class="tableBody" width="100%" valign="top"><?php echo xtc_draw_form('create_account', xtc_href_link(FILENAME_CREATE_GUEST_ACCOUNT, '', 'SSL'), 'post', 'onSubmit="return check_form(create_account);"') . xtc_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
      <tr>
        <td>
	<table border="0" width="68%" cellspacing="0" cellpadding="2">
          <tr>
...
?>
      ...
      <tr>
        <td><?php echo xtc_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
					...
					<tr>
            <td class="main"><?php echo xtc_draw_hidden_field('password'); ?></td>
          </tr>
					<tr>
            <td class="main"><?php echo xtc_draw_hidden_field('confirmation'); ?></td>
          </tr>
