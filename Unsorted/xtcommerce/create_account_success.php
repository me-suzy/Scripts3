<?php
/* -----------------------------------------------------------------------------------------
   $Id: create_account_success.php,v 1.1 2003/09/06 21:38:27 fanta2k Exp $   
  ...
  if (sizeof($_SESSION['navigation']->snapshot) > 0) {
    ...
    $origin_href = xtc_href_link(FILENAME_DEFAULT);
  }
?>
    ...
    <td class="tableBody" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td><?php echo xtc_image(DIR_WS_IMAGES . 'table_background_man_on_board.gif', HEADING_TITLE); ?></td>
      ...
      <tr>
        <td align="right"><br><?php echo '<a href="' . $origin_href . '">' . xtc_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></td>
      </tr>
    </table></td>
<!-- body_text_eof //-->
