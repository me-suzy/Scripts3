<?php
/* -----------------------------------------------------------------------------------------
   $Id: ssl_check.php,v 1.1 2003/09/06 21:38:27 fanta2k Exp $   
  ...
  $breadcrumb->add(NAVBAR_TITLE, xtc_href_link(FILENAME_SSL_CHECK));
?>
...
<!-- body_text //-->
    <td class="tableBody" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="right" class="main"><?php echo '<a href="' . xtc_href_link(FILENAME_LOGIN) . '">' . xtc_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></td>
      </tr>
    </table></td>
<!-- body_text_eof //-->
