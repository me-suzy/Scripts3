<?php
/* --------------------------------------------------------------
   $Id: english.php,v 1.1 2003/09/06 21:54:33 fanta2k Exp $   
   ...
   (c) 2002-2003 osCommerce(english.php,v 1.105 2003/05/28); www.oscommerce.com 
   (c) 2003	 nextcommerce (english.php,v 1.17 2003/08/24); www.nextcommerce.org
...
define('BOX_CONFIGURATION_2', 'Minumum Values');
...
define('BOX_MODULES', 'Payment-/Shipping-/Billing');
...
define('BOX_REVIEWS', 'Producct Reviews');
define('BOX_XSELL_PRODUCTS', 'Cross Marketing');
define('BOX_SPECIALS', 'Spezial Pricing');
...
define('BOX_STATS_CUSTOMERS', 'Purchaseing Statistics');
define('BOX_BACKUP', 'Database Backup');
...
define('BOX_HEADING_PRODUCTS','Products');
...
define('ENTRY_MAIL_ERROR','&nbsp;<span class="errorText">required</span>');
define('ENTRY_PASSWORD','Password (generated)');
define('ENTRY_PASSWORD_ERROR','min ' . ENTRY_PASSWORD_MIN_LENGTH . ' chars ');
...
define('IMAGE_STATUS','Customers Group');
define('IMAGE_IPLOG','IP-Log');
define('CREATE_ACCOUNT','New Customer');
