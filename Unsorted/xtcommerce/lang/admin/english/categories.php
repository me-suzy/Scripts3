<?php
/* --------------------------------------------------------------
   $Id: categories.php,v 1.1 2003/09/06 21:54:33 fanta2k Exp $   
   ...
   (c) 2002-2003 osCommerce(categories.php,v 1.24 2002/08/17); www.oscommerce.com 
   (c) 2003	 nextcommerce (categories.php,v 1.9 2003/08/14); www.nextcommerce.org
...
define('HEADING_PRODUCT_OPTIONS','<b>Product informations</b>');
