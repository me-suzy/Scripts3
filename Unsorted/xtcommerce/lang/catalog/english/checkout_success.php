...
/* -----------------------------------------------------------------------------------------
   ...
   (c) 2002-2003 osCommerce(checkout_success.php,v 1.12 2003/04/15); www.oscommerce.com 
   (c) 2003	 nextcommerce (checkout_success.php,v 1.4 2003/08/13); www.nextcommerce.org
...
define('TEXT_SEE_ORDERS', 'You can view your order history by going to the <a href="' . xtc_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">\'My Account\'</a> page and by clicking on <a href="' . xtc_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '">\'History\'</a>.');
define('TEXT_CONTACT_STORE_OWNER', 'Please direct any questions you have to the <a href="' . xtc_href_link(FILENAME_CONTACT_US) . '">store owner</a>.');
