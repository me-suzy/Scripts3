<?php
/* -----------------------------------------------------------------------------------------
   $Id: english.php,v 1.2 2003/09/07 10:48:23 fanta2k Exp $   
   ...
   (c) 2002-2003 osCommerce(english.php,v 1.110 2003/05/19); www.oscommerce.com 
   (c) 2003	 nextcommerce (english.php,v 1.16 2003/08/21); www.nextcommerce.org
...
// on RedHat try 'en_US'
// on FreeBSD try 'en_US.ISO_8859-15'
// on Windows try 'en', or 'English'
@setlocale(LC_TIME, 'en_US.ISO_8859-15');
...
define('BOX_HEADING_ADMIN', 'Admin Informations');
define('BOX_ENTRY_CUSTOMERS','Customers');
define('BOX_ENTRY_PRODUCTS','Products');
define('BOX_ENTRY_REVIEWS','Reviews');
define('BOX_TITLE_STATISTICS','Statistics:');

define('BOX_HEADING_CONTENT','More About');
...
define('WARNING_INSTALL_DIRECTORY_EXISTS', 'Warning: Installation directory exists at: ' . dirname($HTTP_SERVER_VARS['SCRIPT_FILENAME']) . '/xtc_installer. Please remove this directory for security reasons.');
...
define('WARNING_SESSION_DIRECTORY_NON_EXISTENT', 'Warning: The sessions directory does not exist: ' . xtc_session_save_path() . '. Sessions will not work until this directory is created.');
define('WARNING_SESSION_DIRECTORY_NOT_WRITEABLE', 'Warning: I am not able to write to the sessions directory: ' . xtc_session_save_path() . '. Sessions will not work until the right user permissions are set.');
...
*/
define('FOOTER_TEXT_BODY', 'Copyright &copy; 2003 <a href="http://www.xt-commerce.com" target="_blank">XT-Commerce</a><br>Powered by <a href="http://www.bytecamp.net" target="_blank">bytecamp</a>');

//  conditions check
define('BOX_INFORMATION_IMPRESSUM', 'Impressum');

define('ERROR_CONDITIONS_NOT_ACCEPTED', 'If you do not accept our conditions, we cannot process your order!');

define('SUB_TITLE_OT_DISCOUNT','Discount:');
define('SUB_TITLE_SUB_NEW','Total:');

define('NOT_ALLOWED_TO_SEE_PRICES','You are not allowed to see prices');
define('NOT_ALLOWED_TO_ADD_TO_CART','You are not allowed to add Products into the cart');
...
define('BOX_LOGINBOX_INCL','All Prices incl. Tax');
define('BOX_LOGINBOX_EXCL','All Prices excl. Tax');
define('BOX_LOGINBOX_DISCOUNT','Product Discount');
define('BOX_LOGINBOX_DISCOUNT_TEXT','You got');
define('BOX_LOGINBOX_DISCOUNT_OT','Rebate');
define('TAX_ADD_TAX','inkl. ');
define('TAX_NO_TAX','add. ');
define('NOT_ALLOWED_TO_SEE_PRICES_TEXT','You have not enough permissions to see our prices. Please registrate.');
