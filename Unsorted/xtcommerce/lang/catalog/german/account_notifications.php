<?php
/* -----------------------------------------------------------------------------------------
   $Id: account_notifications.php,v 1.1 2003/09/06 21:54:34 fanta2k Exp $   
   ...
   (c) 2002-2003 osCommerce(account_notifications.php,v 1.1 2003/05/19); www.oscommerce.com 
   (c) 2003	 nextcommerce (account_notifications.php,v 1.5 2003/08/16); www.nextcommerce.org
...
define('MY_NOTIFICATIONS_DESCRIPTION', 'Diese Benachrichtigungen erlabuben es Ihnen, &uuml;ber alle &Auml;nderungen an einem Produkt informiert zu werden.<br><br>Wenn Sie Benachrichtigungen f&uuml;r unser komplettes Angebot erhalten wollen, sollte Sie die allgemeinen Benachrichtigungen aktivieren.');
