<?php
/* -----------------------------------------------------------------------------------------
   $Id: index.php,v 1.1 2003/09/06 21:38:27 fanta2k Exp $   
...
<?php
  // Added For testing customers_status v3.x
  if ($customer_status_value['customers_status_public'] == 1) {
    echo "Hello " . $customer_id ." your status is " . $customer_status_value['customers_status_name'] . " and you have " . $customer_status_value['customers_status_discount'] . "% discount. Vos droits de membre :" .  $customer_status_value['customers_status_ot_discount_flag'] . 'avec une remise totale de :' .  $customer_status_value['customers_status_ot_discount'] ;
  }
  // End Add V3.x //-->
?>
<!-- header //-->
