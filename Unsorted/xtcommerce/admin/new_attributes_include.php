<?php
/* --------------------------------------------------------------
   $Id: new_attributes_include.php,v 1.1 2003/09/06 22:05:29 fanta2k Exp $   
...
?>
  <tr>
    <td colspan="10" class="main"><br><input type="image" src="<?php echo $adminImages; ?>button_save.gif">&nbsp;&nbsp;&nbsp;<?php echo $backLink; ?><img src="<?php echo $adminImages; ?>button_cancel.gif" border="0"></a></td>
  </tr>
</form>