<?php
/* --------------------------------------------------------------
   $Id: new_attributes_change.php,v 1.1 2003/09/06 22:05:29 fanta2k Exp $   
  ...
  if ($optionTypeTextInstalled == '1' && is_array($_POST['optionValuesText'])) {
    for ($i = 0; $i < sizeof($_POST['optionValuesText']); $i++) {
      ...
      mysql_query("INSERT INTO products_attributes (products_id, options_id, options_values_id, options_values_price, price_prefix) VALUES ('" . $_POST['current_product_id'] . "', '" . $value_product_id . "', '" . $optionTypeTextInstalledID . "', '" . $value_price . "', '" . $value_prefix . "')") or die(mysql_error());
    }
  }
?>