<?php
/* --------------------------------------------------------------
   $Id: group_prices.php,v 1.1 2003/09/06 22:05:29 fanta2k Exp $   
...
?><table width="100%" border="0" bgcolor="f3f3f3" style="border: 1px solid; border-color: #cccccc;">
          <tr>
            ...
            <td width="50%" class="main"><?php echo xtc_draw_input_field('products_price', $pInfo->products_price); ?></td>
          </tr>
<?php
...
?>
          <tr>
            ...
            <td style="border-top: 1px solid; border-color: #cccccc;" class="main"><?php echo xtc_draw_input_field('products_price_' . $group_data[$col]['STATUS_ID'], get_group_price($group_data[$col]['STATUS_ID'], $pInfo->products_id));
      if ($_GET['pID'] != '') {
...
?>
              <tr>
                ...
                <td width="5">&nbsp;</td>
                <td width="142" class="main" style="border: 1px solid; border-color: #cccccc;"><?php echo $staffel_values['personal_offer']; ?></td>
                <td width="80" align="left"><?php echo xtc_draw_separator('pixel_trans.gif', '1', '10'); ?><a href="<?php echo xtc_href_link(FILENAME_CATEGORIES, 'cPath=' . $cPath . '&function=delete&quantity=' . $staffel_values['quantity'] . '&statusID=' . $group_data[$col]['STATUS_ID'] . '&action=new_product&pID=' . $_GET['pID']); ?>"><?php echo xtc_image_button('button_delete.gif', IMAGE_DELETE); ?></a></td>
              </tr>
              <tr>
