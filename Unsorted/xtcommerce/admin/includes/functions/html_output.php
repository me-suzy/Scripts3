<?php
/* --------------------------------------------------------------
   $Id: html_output.php,v 1.1 2003/09/06 22:05:29 fanta2k Exp $   
  ...
  function xtc_image_submit($image, $alt, $params = '') {
    ...
    return '<input type="image" src="' . DIR_WS_CATALOG.'lang/admin/' . $_SESSION['language'] . '/images/buttons/' . $image . '" border="0" alt="' . $alt . '"' . (($params) ? ' ' . $params : '') . '>';
  }
  ...
  function xtc_image_button($image, $alt = '', $params = '') {
    ...
    return xtc_image(DIR_WS_CATALOG.'lang/admin/'. $_SESSION['language'] . '/images/buttons/' . $image, $alt, '', '', $params);
  }
