<?php
/* --------------------------------------------------------------
   $Id: install_step1.php,v 1.1 2003/09/06 21:42:56 fanta2k Exp $   
          ...
          <tr> 
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <p><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b> <?php echo TEXT_WS_ADMINTOOL; ?></b><br>
                <?php echo xtc_draw_input_field_installer('DIR_WS_ADMIN', $dir_ws_www_root . '/admin/'); ?><br>
