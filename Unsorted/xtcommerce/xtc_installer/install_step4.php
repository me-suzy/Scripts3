<?php
  /* --------------------------------------------------------------
   $Id: install_step4.php,v 1.1 2003/09/06 21:42:56 fanta2k Exp $   
...
/*    
//delete existing configure files
  if (file_exists(DIR_FS_CATALOG . 'includes/configure.php')) unlink(DIR_FS_CATALOG . 'includes/configure.php');
  if (file_exists(DIR_FS_CATALOG . 'includes/configure.org.php')) unlink(DIR_FS_CATALOG . 'includes/configure.org.php');
  if (file_exists(DIR_FS_CATALOG . 'admin/includes/configure.php')) unlink(DIR_FS_CATALOG . 'admin/includes/configure.php');
  if (file_exists(DIR_FS_CATALOG . 'admin/includes/configure.org.php')) unlink(DIR_FS_CATALOG . 'admin/includes/configure.org.php');
*/
...
?>
            ...
            <div class="boxMe"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo TEXT_STEP4_ERROR; ?></font>
              <ul class="boxMe">
                <li><font size="1" face="Verdana, Arial, Helvetica, sans-serif">cd <?php echo DIR_FS_CATALOG; ?>includes/</font></li>
