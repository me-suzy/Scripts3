<?php
/* -----------------------------------------------------------------------------------------
   $Id: shop_content.php,v 1.1 2003/09/06 21:38:27 fanta2k Exp $   
  ...
  require_once('inc/xtc_image_button.inc.php');
  ...
  $breadcrumb->add($shop_content_data['content_title'], xtc_href_link(FILENAME_CONTENT.'coID='.$_GET['coID']));
?>
    ...
    <td class="tableBody" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo $shop_content_data['content_heading']; ?></td>
...
?>
      ...
      <tr>
        <td align="right" class="main"><br><?php echo '<a href="' . xtc_href_link(FILENAME_DEFAULT) . '">' . xtc_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></td>
      </tr>
    </table></td>
<!-- body_text_eof //-->
