  ...
  class ipayment {
      ...
      $selection = array('id' => $this->code,
                         ...
                         'fields' => array(array('title' => MODULE_PAYMENT_IPAYMENT_TEXT_CREDIT_CARD_OWNER,
                                           ...
                                           array('title' => MODULE_PAYMENT_IPAYMENT_TEXT_CREDIT_CARD_EXPIRES,
                                                 'field' => xtc_draw_pull_down_menu('ipayment_cc_expires_month', $expires_month) . '&nbsp;' . xtc_draw_pull_down_menu('ipayment_cc_expires_year', $expires_year)),
    ...
    function process_button() {
      ...
      $process_button_string = xtc_draw_hidden_field('silent', '1') .
                               ...
                               xtc_draw_hidden_field('cc_checkcode', $_POST['ipayment_cc_checkcode']) .
                               xtc_draw_hidden_field('addr_name', $_POST['ipayment_cc_owner']) .
                               ...
                               xtc_draw_hidden_field('silent_error_url', xtc_href_link(FILENAME_CHECKOUT_PAYMENT, 'payment_error=' . $this->code . '&ipayment_cc_owner=' . urlencode($_POST['ipayment_cc_owner']), 'SSL', true));
