...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      if (xtc_not_null($this->html_images)) {
      ...
      $null = NULL;
      $attachments = ((xtc_not_null($this->attachments)) ? true : false);
      $html_images = ((xtc_not_null($this->html_images)) ? true : false);
      $html = ((xtc_not_null($this->html)) ? true : false);
      $text = ((xtc_not_null($this->text)) ? true : false);
...
//          $message =& $this->add_mixed_part();
        ...
        case (($html == true) && ($attachments == false) && ($html_images == false)):
          if (xtc_not_null($this->html_text)) {
/* HPDL PHP3 */
