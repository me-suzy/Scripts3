...
$ubbt_lang['PERM_FORM_DETAIL'] = "A parent or guardian must mail or fax a signed permission form to the administrators of this forum before a user under age 13 can complete the registration.<br /><br /><a href=\"{$config['phpurl']}/coppaform.php\">Permission Form</a>";
$ubbt_lang['NO_PERM_FORM'] = "We do not allow access to children under 13 so we do not have parental forms available.";
...
$ubbt_lang['NEW_USER2']  = 	"Enter the following information to register a Username.  Initial passwords are randomly generated (unless specified otherwise), so a valid email address is required so this can be mailed to you.";
$ubbt_lang['USER_IN']  = 	"Username (between 3 and 16 characters alphanumeric only)";
...
$ubbt_lang['SIMP_EMAIL']  = 	"Email Address";
?>
