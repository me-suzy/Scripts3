...
# Official Release Date for UBBThreads Version6: December 12,2000.
...
# Note: if you modify ANY code within UBBThreads¡Awe at Infopop Corporation
...
// Send the page to them
  $html = new html; 
  $html -> send_header("FAQ (±`¨£°ÝÃD¶°)",$Cat,0,0,0,0,$user);
  ...
  <font class=standouttext>
  [blush]
  </font> = <img src=\"$config[images]/icons/blush.gif\"><br>

  <font class=standouttext>
  [cool]
  </font> = <img src=\"$config[images]/icons/cool.gif\"><br>

  <font class=standouttext>
  [crazy]
  </font> = <img src=\"$config[images]/icons/crazy.gif\"><br>

  <font class=standouttext>
  [frown]
  </font> = <img src=\"$config[images]/icons/frown.gif\"><br>

  <font class=standouttext>
  [laugh]
  </font> = <img src=\"$config[images]/icons/laugh.gif\"><br>

  <font class=standouttext>
  [mad]
  </font> = <img src=\"$config[images]/icons/mad.gif\"><br>

  <font class=\"standouttext\">
  [shocked]
  </font> = <img src=\"$config[images]/icons/shocked.gif\"><br>

  <font class=standouttext>
  [smile]
  </font> = <img src=\"$config[images]/icons/smile.gif\"><br>

  <font class=standouttext>
  [tongue]
  </font> = <img src=\"$config[images]/icons/tongue.gif\"><br>

  <font class=standouttext>
  [wink]
  </font> = <img src=\"$config[images]/icons/wink.gif\"><br>
 ...
 <font class=standouttext>
  ...
  ¥i¥H¡A³o®M UBBThreads ¦ì©ó <a href=\"http://www.infopop.com\">www.infopop.com</a>
