...
$ubbt_lang['NEW_USER2']  = 	"Introduceti urmatoarele informatii pentru a inregistra un nume. Parola se genereaza aleator (exceptind cazurile in care se specifica altfel), asa ca aveti nevoie de o adresa valida de email pentru a o putea primi.";
$ubbt_lang['USER_IN']  = 	"Nume (intre 3 si 16 caractere)";
$ubbt_lang['OPT_PASS']  = 	"Optional: Alege o parola intre 4 si 20 caractere (continind numai caractere alfanumerice).";
$ubbt_lang['VER_PASS']  = 	"Verifica parola";
$ubbt_lang['SIMP_EMAIL']  = 	"Adresa de email";
