...
// ------------------------
// Send them a page 
   $html -> send_header ("Close threads",$Cat,0,$user);
   $html -> admin_table_header("Close threads");
   $html -> open_admin_table();

   echo "
    <tr><td class=\"lighttable\" colspan=\"4\">
    Place a checkmark by any threads you wish to close. 
    <FORM METHOD = POST action =\"{$config['phpurl']}/admin/doclosethreads.php\">
    <INPUT TYPE=HIDDEN NAME=Cat VALUE=$Cat>
    <input type=hidden name=Keyword value=$Keyword>
    </td></tr>
    <tr><td class=\"tdheader\">Close</td> 
