...
// Set the info text
   if ($choice == "unapproved") {
      $text = "that have not been approved.";
   }
   elseif ($choice == "viewexpthreads") {
      $text = "that you may expire.";
   }
   elseif ($choice == "viewothreads") {
      $text = "that you may close.";
   }
   elseif ($choice == "viewcthreads") {
      $text = "that are close and you may reopen.";
   }
   elseif ($choice == "viewunkeptthreads") {
      $text = "that you may keep.";
   }
   elseif ($choice == "viewkeptthreads") {
      $text = "that are kept.";
   }
...
// Send them a page 
   ...
   echo "
    ...
    First choose a forum and then you will be shown a list of posts for that forum $text 

    <FORM METHOD = POST action =\"{$config['phpurl']}/admin/$choice.php\">
    <INPUT TYPE=HIDDEN NAME=Cat VALUE=$Cat>
    <select name=\"Keyword\" class=\"formboxes\">
   ";
