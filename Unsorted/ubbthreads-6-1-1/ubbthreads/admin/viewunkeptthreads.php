...
// ------------------------
// Send them a page 
   $html -> send_header ("Keep threads",$Cat,0,$user);
   $html -> admin_table_header("Keep threads");
   $html -> open_admin_table();

   echo "
    <FORM METHOD = POST action =\"{$config['phpurl']}/admin/dokeepthreads.php\">
    <INPUT TYPE=HIDDEN NAME=Cat VALUE=$Cat>
    <input type=hidden name=Keyword value=$Keyword>

    <TR><TD COLSPAN=4 class=\"lighttable\">
    Place a checkmark by any threads you wish to keep. 
    </TD></TR>
    <tr><td class=\"tdheader\">Keep</td> 
