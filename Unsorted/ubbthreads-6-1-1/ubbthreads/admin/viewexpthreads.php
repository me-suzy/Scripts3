...
// ------------------------
// Send them a page 
   $html -> send_header ("Expire threads",$Cat,0,$user);
   $html -> admin_table_header("Expire threads");
   $html -> open_admin_table();

   echo "
    <FORM METHOD = POST action =\"{$config['phpurl']}/admin/doexpirethreads.php\">
    <INPUT TYPE=HIDDEN NAME=Cat VALUE=$Cat>
    <input type=hidden name=Keyword value=$Keyword>

    <TR><TD colspan=4 class=\"lighttable\">
    Place a checkmark by any threads you wish to expire. 
    </TD></TR>
    <tr><td class=\"tdheader\">Expire</td> 
