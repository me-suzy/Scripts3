...
// Mark the B_Posted and B_Last_Post as sticky and update the sticky field 
   $query = "
    ...
    SET    B_Sticky    = B_Last_Post,
           B_Posted    = '4294967295',
           B_Last_Post = '4294967295'
...
// ------------------------
// Send them a page 
   $html -> send_header ("Post Marked Sticky",$Cat,"<META HTTP-EQUIV=\"Refresh\" content=\"5;url={$config['phpurl']}/postlist.php?Cat=$Cat&Board=$Board&view=$view&sb=$sb&o=$o\">",$user);
   $html -> admin_table_header("Post Marked Sticky");
   echo "<TABLE BORDER=0 WIDTH=\"95%\" ALIGN=\"center\"><TR><TD class=\"cleartable\"><span class=\"onbody\">";  
   echo "The selected post has been marked as sticky and will appear at the top when sorting by descending date.";
