...
define("_LASTNEWS","Last news about");
...
define("_NOANONCOMMENTS","No Comments Allowed for Anonymous, please <a href=\"user.php\">register</a>");
...
define("_ASREGISTERED","Don't have an account yet? You can <a href=\"user.php\">create one</a>. As registered user you have some advantages like theme manager, comments configuration and post comments with your name.");
...
define("_WHOSONLINE","Buddy's Online");
define("_YOUARELOGGED","You are logged as");
define("_YOUHAVE","You have");
define("_PRIVATEMSG","private message(s).");
define("_YOUAREANON","You are Anonymous user. You can register for free by clicking <a href=\"user.php\">here</a>");
...
define("_RCREATEACCOUNT","<a href=user.php>Create</a> an account");
...
define("_YOUCANFIND","Here you will find more articles.");
...
define("_ACTIVEAUTHORS","Administrators:");
define("_STORIESPUBLISHED","News Articles:");
define("_SACTIVETOPICS","News Topics:");
define("_COMMENTSPOSTED","Comments to News:");
...
define("_NUKEVERSION","vbPortal Version:");
...
define("_SUBMITADVICE","Please write your article/story filling the following form and double check your submission.<br>You're adviced that not all submission will be posted.<br>Your submission will be checked for proper grammar and maybe edited by our staff.");
...
define("_TOPIC","Topic");
define("_ARTICLETEXT","Article Text:");
...
define("_YOUAREREGISTERED","You are now registered. You should receive your password at the email account you provided.");
...
define("_PASSWILLSEND","(Password will be send to the email address you enter)");
...
define("_EMAILALREADYEXIST","ERROR: Email address already registered");
...
define("_FILEINFO","File Information");
define("_CHECK","Check");
...
define("_PROGRAMNAME","Program Name");
define("_FILESIZE","Filesize");
define("_VERSION","Version");
define("_UPLOADDATE","Upload Date");
define("_DESCRIPTION","Description");
define("_UDOWNLOADS","Downloads");
define("_AUTHOR","Author");
define("_HOMEPAGE","HomePage");
define("_DOWNLOADNOW","Download this file Now!");
define("_SELECTCATEGORY","Select Category Folder");
define("_ALLFILES","All Files");
define("_INFO","Info");
define("_DISPLAYFILTERED","Display Filtered with");
define("_SORTED","sorted");
define("_ASCENDING","Ascending");
define("_DESCENDING","Descending");
define("_NAME","Name");
define("_CREATIONDATE","Creation Date");
define("_DOWNLOADSECTION","Download Section");
define("_NOSUCHFILE","There isn't such file...");
...
define("_DOWNLOADSNOTUSER8","<a href=\"user.php\">Register for an Account</a>");
...
define("_ONLYREGUSERSMODIFY","Only registered users can suggest downloads modifications. Please <a href=\"user.php\">register or login</a>.");
...
define("_DRATENOTE4","You can view a list of the <a href=\"downloads.php?op=TopRated\">Top Rated Resources</a>.");
...
define("_BBCODEDISSABLE","Disable <a href=\"bbcode_ref.php\" target=\"_blank\"><i>BBCode</i></a> on this Post");
define("_SMILEDISSABLE","Disable <a href=\"bb_smilies.php\" target=\"_blank\"><i>smilies</i></a> on this Post");
define("_SHOWSIGNATURE","Show Signature");
define("_SIGNATUREMSG","This can be altered or added in your profile");
...
define("_LINKRECEIVED","Thank you! We have received your Link submission.");
define("_EMAILWHENADD","You'll receive and E-mail when it's approved.");
define("_CHECKFORIT","You chose not to include your email address, however your link will be approved if it has been proven proper content by the administration");
...
define("_WEAPPRECIATE","We appreciate your visit to");
...
define("_RATENOTE4","You can view a list of the <a href=\"links.php?op=TopRated\">Top Rated Resources</a>.");
...
define("_CURRENTDIR","Current Directory is");
define("_BACKTOROOT","Back to root");
define("_REFRESH","Refresh");
define("_ADMINID","Admin ID");
define("_ADMINLOGIN","Administration System Login");
define("_FAQ","FAQ");
define("_DOWNLOAD","Download");
define("_HEADLINES","Healines");
define("_LEFTBLOCKS","Left Blocks");
define("_WEBLINKS","Web Links");
define("_MAINBLOCK","Main Block");
define("_EDITADMINS","Edit Admins");
define("_ADMINBLOCK","Admin Block");
...
define("_AUTOARTICLES","Auto Articles");
...
define("_FIXEDBLOCKS","Fixed System Blocks");
define("_TITLE","Title");
...
define("_USERBLOCKS","User Defined Blocks");
define("_TYPE","Type");
...
define("_TOPICIMAGE1","image name + extension located in");
define("_TOPICIMAGE2","(for example: games.gif)");
...
define("_YOURIP","Your IP to not count the hits");
...
define("_SURVEYSCONF","Surveys/Polls Options");
define("_SCALEBAR","Scale of Result Bar");
define("_ALLOWTWICE","Allow users to vote twice?");
define("_GRAPHICOPT","Graphics Options");
define("_TOPICSPATH","Topics Images Path");
define("_USERPATH","User Menu Images Path");
define("_ADMINPATH","Admin Menu Images Path");
define("_ADMINGRAPHIC","Graphics in Administration Menu?");
define("_SITEFONT","Site Font");
define("_MISCOPT","Miscelaneous Options");
define("_ARTINADMIN","Articles Number in Admin");
...
define("_EPHEMACT","Activate Ephemerids System?");
...
define("_CHANGEDIR","Change working directory to");
define("_MOVRENCP","Move, Rename or Copy");
define("_TOUCH","Touch");
define("_AUDIO","Audio");
define("_WEBPROGRAM","Web Program");
define("_APACHESET","Apache Webserver security settings");
define("_WEBPAGE","Web Page");
define("_UNKOWNFT","Unkown file type");
define("_UPLOADFILE","Upload File");
define("_CREATEDIR","Create Directory");
define("_CREATEFILE","Create File");
define("_HTMLTEMP","(html template)");
define("_UPLOADED","Uploaded");
define("_LISTINGDIR","Listing Directory");
define("_BROWSE","Browse");
define("_LISTDIR","Listing Directory");
define("_CHANGED2ROOT","Changed to root directory");
define("_DISPHP","Displaying PHP environment");
define("_CHANGEDDIR","Changed directory to");
define("_TOUCHED","Touched");
define("_DELETED","Deleted");
define("_FMSURE2DEL","Are you sure you want to DELETE");
define("_DESTFILEEXT","Destination file already exists. Aborted.");
define("_COPIED","Copied");
define("_MOVREN","Moved/Renamed");
define("_MOVRENAMING","Moving/renaming or copying");
define("_COPY","Copy");
define("_MOVREN2","Move/Rename");
define("_EDITED","Edited");
define("_EDITING","Editing");
define("_DISPLAYING","Displaying");
define("_THEDIR","The directory");
define("_ALREADYEXT","already exists.");
define("_DIRCREATED","Created the directory");
define("_CREATED","Created");
define("_CREATING","Creating");
...
define('_AB_ALINKCONTENT','Admin Links');
define('_AB_BLOCKSADMIN','&quot;Advanced Blocks&quot; Administration');
define('_AB_BLOCKSLIST','Side Blocks');
define('_AB_BOTTOM', 'Bottom');
define('_AB_BOTTOMBLOCK', 'Bottom Block');
define('_AB_CENTER', 'Center');
define('_AB_CENTERBLOCK', 'Center Block');
define('_AB_INCLUDECONTENT','Included PHP File');
define('_AB_LABEL_URL','URL');
define('_AB_LINKCONTENT','Links');
define('_AB_NNTPCONTENT','NNTP/Usenet Newsgroup');
define('_AB_PHPCONTENT','PHP Script');
define('_AB_RSSCONTENT','RSS/RDF Content');
define('_AB_TEXTCONTENT','HTML/Text File');
define('_AB_TOP', 'Top');
define('_AB_TOPBLOCK', 'Top Block');
define('_AB_TYPE_ALINK','Admin Link');
define('_AB_TYPE_ALINK2','Admin Link List');
define('_AB_TYPE_HTML','HTML/Text');
define('_AB_TYPE_HTML2','HTML/Text Block');
define('_AB_TYPE_INCLUDE','Include');
define('_AB_TYPE_INCLUDE2','Include PHP File');
define('_AB_TYPE_LINK','Link');
define('_AB_TYPE_LINK2','Link List');
define('_AB_TYPE_NNTP','NNTP');
define('_AB_TYPE_NNTP2','NNTP/Usenet');
define('_AB_TYPE_PHP','PHP');
define('_AB_TYPE_PHP2','PHP Script');
define('_AB_TYPE_RDF','RDF/RSS');
define('_AB_TYPE_RDF2','RDF/RSS News');


/*****************************************************/
/* Center Blocks Administration texts                */
/*****************************************************/

define("_CENTERBLOCKSADMIN","Center Blocks Administration");
define("_CENTERBLOCKS","Center Blocks");
define("_FIXEDCENTERBLOCKS","Fixed System Center Blocks");
define("_LEFTBLOCK","Left Block");
define("_RIGHTBLOCK","Right Block");
define("_USERBLOCKS","User Defined Center Blocks");
define("_ADDNEWCENTERBLOCK","Add a New Center Block");
define("_CREATECENTERBLOCK","Create Center Block");
define("_EDITCENTERBLOCK","Edit Center Block");
define("_CENTERBLOCK","Center Block");
define("_CUSTOMCENTERBLOCK","Custom Center Block");
define("_SAVECENTERBLOCK","Save Center Block");
define("_EDITFIXEDCENTERBLOCK","Edit Fixed Center Block");
define("_CENTERBLOCKACTIVATION","Center Block Activation");
define("_CENTERBLOCKPREVIEW","This is the preview for Center Block");
define("_ARESUREDELCENTERBLOCK","Are you sure you want to remove Center Block");

/*****************************************************/
/* vbPortal extra texts                              */
/*****************************************************/

define("_TEMPLATES","Use Templates?");
define("_VBULLETIN_FORUMS","vBulletin and vbPortal");
define("_VBPCATEGORIES","vbPortal Specific Categories");
define("_USER_MAINTENANCE","User Maintenance");
define("_GENERAL_USEAGE","General Board Usage");
define("_READING_POSTING","Reading and Posting Messages");
define("_OTHEROPTIONS","More...");
define("_PRIVILEGES","Privileges");
define("_PRIVSAZ","Privileges (A to Z)");
define("_PRIVSZA","Privileges (Z to A)");
/*****************************************************/
/* vbPortal Admin and Moderators                    */
/*****************************************************/
define("_MODMENU","Moderators Menu");
define("_WAITINGMOD","Waiting Moderation");
...
define("_DATESTRING","%A, %B %d @ %T %Z"); // (Saturday, May 26 @ 01:22:06 EDT)
define("_DATESTRING2","%A, %B %d"); // (Saturday, May 26)
define("_DATESTRING3","%B %d"); // (May 26)
define("_DATESTRING4","%m-%d-%Y"); // (5-26-2001)
define("_DATESTRING5","%d-%m-%Y"); // (26-5-2001)
define("_DATESTRING6","%m/%d"); // (5/26)
define("_DATESTRING7","%m/%d/%Y"); // (5/26/2001)
define("_LINKSDATESTRING","%d-%m-%Y"); // (26-5-2001)
...
function translate($phrase) {
    ...
    case "xdatestring3":    $tmp = "%B %d"; break;
    case "xdatestring4":	$tmp = "%m-%d-%Y"; break;
	case "xdatestring5":    $tmp = "%d-%m-%Y"; break;
    case "xdatestring6":	$tmp = "%m/%d"; break;
    case "xdatestring7":	$tmp = "%m/%d/%Y"; break;
