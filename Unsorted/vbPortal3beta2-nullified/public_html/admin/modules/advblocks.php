...
function BlocksAdmin() {
	...
	if($show_inactive) {
		print ' <font size="1">[ <a href="admin.php?op=AdvBlocksAdmin">hide inactive</a> ]</font>';
	}
	else {
		print ' <font size="1">[ <a href="admin.php?op=AdvBlocksAdmin&amp;show_inactive=1">show inactive</a> ]</font>';
	}
	print '</center><br>'
	...
	while($row = mysql_fetch_array($result)) {
		...
		// functions
		//
		print "<td align=\"left\"><a href=\"admin.php?op=AdvBlocksEdit&amp;bid=$row[bid]\"><img src=\"images/common/edit.gif\" border=\"0\" alt=\"Edit Block\"></a> <a href=\"admin.php?op=AdvBlocksChangeStatus&amp;bid=$row[bid]\"><img src=\"$change_img\" border=\"0\" alt=\"$change\"></a>";
		if($blocks_modules[$row[bkey]][allow_delete]) {
			print " <a href=\"admin.php?op=AdvBlocksDelete&amp;bid=$row[bid]\"><img src=\"images/common/delete.gif\" border=\"0\" alt=\"Delete Block\"></a>";
		}
		print '</td></tr>';
