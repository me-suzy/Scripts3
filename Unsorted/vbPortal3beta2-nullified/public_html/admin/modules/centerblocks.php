...
function BlocksAdmin() {
	...
	OpenTable();
	print '<center><font size="4"><b>Center Blocks</b></font>';
	if($show_inactive) {
		print ' <font size="1">[ <a href="admin.php?op=CenterBlocksAdmin">hide inactive</a> ]</font>';
	}
	else {
		print ' <font size="1">[ <a href="admin.php?op=CenterBlocksAdmin&amp;show_inactive=1">show inactive</a> ]</font>';
	}
	print '</center><br>'
	...
	while($row = mysql_fetch_array($result)) {
		...
		// functions
		//
		print "<td align=\"left\"><a href=\"admin.php?op=CenterBlocksEdit&amp;bid=$row[bid]\"><img src=\"images/common/edit.gif\" border=\"0\" alt=\"Edit Block\"></a> <a href=\"admin.php?op=CenterBlocksChangeStatus&amp;bid=$row[bid]\"><img src=\"$change_img\" border=\"0\" alt=\"$change\"></a>";
		if($centerblocks_modules[$row[bkey]][allow_delete]) {
			print " <a href=\"admin.php?op=CenterBlocksDelete&amp;bid=$row[bid]\"><img src=\"images/common/delete.gif\" border=\"0\" alt=\"Delete Block\"></a>";
		}
		print '</td></tr>';
...
function BlocksEdit($bid) {
	...
	print "<option value=\"$row[weight]\" selected>Current</option>\n";
	print "<option value=\"0.5\">Top</option>\n";
	...
	while($weight_row = mysql_fetch_array($result)) {
		print "<option value=\"" . ($weight_row[weight] + 0.5) . "\">After: $weight_row[title] (" . $text_pos[$weight_row[position]] . ")</option>\n";
	}
	print '</td></tr>';
