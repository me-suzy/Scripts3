...
echo "<center><font size=\"4\"><b>Page still Under Constuction!</b></font></center>";
CloseTable();
echo "<br>\n\n";
OpenTable();
...
if (mysql_num_rows($result)>0) {
echo "<table border=\"0\" cellpadding=\"10\" width=\"100%\"><tr><td align=\"left\">\n"
	."<font size=\"3\"><b>The Top $top Posters</b></font><br><br><font size=\"2\">\n";
$lugar=1;
while ($latest_array = mysql_fetch_array($result)) { 
echo "<font size = 2><strong><big>&middot;</big></strong>&nbsp;$lugar: <A HREF='$bburl/member.php?action=getinfo&userid=$latest_array[userid]'>$latest_array[username]</A>&nbsp;with&nbsp; $latest_array[posts]&nbsp;posts.</FONT><BR>";
$lugar++;
}
 echo "</font></td></tr></table><br>\n";
}
