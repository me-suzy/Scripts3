<?
  ...
  if (session_is_registered("valid_admin"))
  {
	  ...
	  if ($delete)
	  {
		  ...
		  mysql_db_query($database, "DELETE FROM banners WHERE number = $delete LIMIT 1") or die("Database INSERT Error"); 
	}
   ...
   include "../header.290"; 
    	...
    	echo "<br>Banner Deleted<br><a href=banneradd.php>Add A Banner</a>";
