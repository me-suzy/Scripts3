<?
  ...
  $result = mysql_db_query($database, "select * from clickthroughs ORDER BY date and time LIMIT 19") or die ("Database INSERT Error"); 
		
  print "<br><br><font face=arial>Last 20 Clickthroughs To Your Site: ";
