<?PHP
	...
	print "<html>
<head>
<title>Invoice Creation System - Courtesy of PHP-Affiliate v1.0 (http://www.php-affiliate.com)</title>
...
<table width=600 border=0 cellspacing=0 cellpadding=0>
  ...
  <tr> 
    <td width=400> 
      ...
      $result = mysql_db_query($database, "select * from affiliates where refid = '$aff'") or die ("Database INSERT Error"); 
