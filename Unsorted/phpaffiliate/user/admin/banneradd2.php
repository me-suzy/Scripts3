<?
  ...
  if (session_is_registered("valid_admin"))
  {
	  ...
	  mysql_db_query($database, "INSERT INTO banners VALUES ('', '$bannername', '$bannerurl', '$bannerdesc')") or die("Database INSERT Error"); 
      ...
      echo "<p><font face=arial>
    	...
    	echo "<br>Your New Banner Has Been Added<br><a href=banneradd.php>Add Another Banner</a>";
