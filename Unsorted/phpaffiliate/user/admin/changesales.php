<?
  ...
  <table border=0 cellspacing=0 cellpadding=0>
    <tr align=center valign=middle> 
      ...
      <td width=70> 
        ...
        mysql_connect($server, $db_user, $db_pass) or die ("Database CONNECT Error (line 27)"); 
  ...
  mysql_connect($server, $db_user, $db_pass) or die ("Database CONNECT Error (line 50)"); 
  $result = mysql_db_query($database, "select * from sales where refid = '$change' ORDER BY date and time") or die ("Database INSERT Error"); 
		
  print "<br><br><font face=arial>Sales From ";
  print $change;
  print " For Your Site: ";
