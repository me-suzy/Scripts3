...
<?
  if ((testGroupAccess($group)) && ($message))
...
//       '&amp;group='.urlencode($group).'">Cancel</a>]'."\n";
  echo '<span class="np_button"><a class="np_button" href="'.
       $file_thread.'?group='.urlencode($group).'">'.$group."</a></span>\n";
  if (($rawview==true) && ($message))
    echo '<span class="np_button"><a class="np_button" href="'.
         $file_rawarticle.'?id='.urlencode($id).
         '&amp;group='.urlencode($group).'">'.$text_article["button_rawview"].
         "</a></span>\n";
  echo '<span class="np_button"><a class="np_button" href="'.
