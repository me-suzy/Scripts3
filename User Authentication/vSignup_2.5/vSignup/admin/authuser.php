...
if ($action == "Add") {
	...
	elseif ($situation == "invalid username") {
		$message = "Username must not contains an apostrophe (').";
		$action = "";
	}
	elseif ($situation == "invalid password") {
		$message = "Password must not contain an apostrophe (').";
		$action = "";
	}
	elseif ($situation == 1) {
...
if ($action == "Modify") {
	...
	elseif ($update == "invalid password") {
		$message = "Password must not contains an apostrophe (').";
		$action = "Modify";
	}
	  ...
	  <form name="AddUser" method="Post" action="authuser.php">
	    <table width="95%" border="1" cellspacing="0" cellpadding="0" align="center" bordercolor="#000000">
            ...
            <td width="73%"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp; 
              <?   
			  	if (($action == "Modify") || ($action=="Add") || ($act=="Edit")) {
					...
					print "<input type=\"text\" name=\"username\" size=\"15\" maxlength=\"15\" value=\"" . stripslashes($username) . "\">"; 
				}
          ...
          <tr valign="middle"> 
            ...
            <td width="73%"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp; 
              <? print "<input type=\"password\" name=\"password\" size=\"20\" maxlength=\"15\" value=\"" . stripslashes($password) . "\">"; ?>
              </font></td>
          </tr>
          <tr valign="middle"> 
          ...
          <tr valign="middle"> 
            ...
            <td width="73%"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">&nbsp; 
              ...
              <a href="authgroup.php">Add</a> &nbsp;
			
			
			<?php
				// Do not show this link if user record has not yet been saved
				if ($username != '')
				{
					print "<a href=\"userdetail.php?username=$username\">User Detail</a>";
				}			
		 	?>
