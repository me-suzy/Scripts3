...
$changepassword = "http://" . $_SERVER['HTTP_HOST'] . "/Scripts/vSignup/chgpwd.php"; // Path to change password file
$login = "http://" . $_SERVER['HTTP_HOST'] . "/Scripts/vSignup/login.php"; // Path to page with the login box
$logout = "http://" . $_SERVER['HTTP_HOST'] . "/Scripts/vSignup/logout.php"; // Path to logout page
...
$dbname	= "signup-test"; 	// Change this to the proper DB Name
