...
<input type="submit" name="change" value="Change password" style="font-size:10px;">
</form>
</div>
<?
...
{
$query = "update i_users set passwd = '$_POST[new_passwd]' where username = '$_SESSION[valid_user]'";
  $result = mysql_query($query, $db_conn);
echo "<div class=\"log\">password changed</div>";
$_SESSION['pass'] = $_POST['new_passwd'];
}
?>
