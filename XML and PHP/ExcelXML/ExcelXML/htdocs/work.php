...
<A name='note_1'></A><H1>ExcelXML (read and output to HTML) - TEST</H1>
...
<DIV style="PADDING-RIGHT:0px;PADDING-BOTTOM:15px;PADDING-TOP:10px;" align='CENTER'>| <A href="index.php">Notes</A> |</DIV>


<TABLE border="0" cellspacing="0" cellspacing="0"><TR><TD  class="text">
<DIV style="PADDING-LEFT:0px;PADDING-BOTTOM:3px;"><A href="work.php#work">To test a script</A> (To check up work of a script on the document)</DIV>
...
<A name='work'></A>
<H2>Upload your Excel document on XML format</H2>
<?
if ($upload) {
//   pr($_FILES['file']['type']);
   if ($_FILES['file']['type']=='text/xml')   copy($file, 'file/test.xml');
   else echo "<FONT COLOR='RED'><B>error: this is not XML file</B></FONT>";
}
echo "<FORM method=POST enctype=\"multipart/form-data\">\n"; 
echo "ExcelXML file<BR>\n";
echo "<INPUT type=file name=file><BR>\n";
echo "<INPUT type=submit value='Upload File' name=upload><BR>\n";
echo "</FORM><BR>\n";


if (!file_exists('file/test.xml')) {
   echo "<BR><FONT COLOR='RED'><B>error: ExcelXML file is not exist, please upload ExcelXML file</B></FONT>";
   return;
}
...
echo "<TR><TD class=\"bright\" style=\"border-bottom: 1pt solid #999999;\">&nbsp;</TD><TD style=\"border-bottom: 1pt solid #999999;\">&nbsp;</TD><TD style=\"border-bottom: 1pt solid #999999;\"><B><I><FONT color=#FF6215>Result:</TD></TR>";
