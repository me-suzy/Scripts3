  phpFaber TinyLink FREE
  Version 1.0.004 - 08/03/2005
  http://www.phpfaber.com/

  Copyright (C) 2003-2004 phpFaber LLC <support@phpfaber.com>

COPYRIGHT NOTICE:
----------------------------------------------------
This script is being offered as freeware. It may be used free of charge
for use under the following conditions:

    1. The 'Powered By phpFaber TinyLink' text
       remains/is placed on the bottom of the list pages.
    2. The text is linked to:
            http://phpfaber.com/i/products/
...
By using this program you agree to indemnify phpFaber LLC 
from any liability.
...
Features:
----------------------------------------
[1] phpFaber TinyLink was created as a service to make posting long URLs easier.
...
[2] Edit ./tiny_includes/config.ini.php file. Set
...
[3] CHMOD ./tiny_includes/config.ini.php file to 666

[4] CHMOD ./tiny_templates_c folder to 777
...
e.g.: http://www.example.com/tiny_admin/admin.php
