<?php
$top=<<<TOP
<DIV class=bor750><input type=hidden name="tab_sort" value="%%TABSORT%%"><table width=750 border=0 cellspacing=0 cellpadding=0><tr height=20>
...
<td width="100%"><SPAN class=f11><b>%%GRPG%%</b>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN></td></tr></table></td><td width=132><table width="100%" border=0 cellspacing=0 cellpadding=0>
...
<td width="100%"><SPAN class=f11><a href="#visitors" style="color:#000000"><b>%%VISITORS%%</b></a><b>, %</b></SPAN></td></tr></table>
</td><td width=132><table width="100%" border=0 cellspacing=0 cellpadding=0><tr valign=center align=center>
...
<td width="100%"><SPAN class=f11><a href="#hosts" style="color:#000000"><b>%%HOSTS%%</b></a><b>, %</b></SPAN></td></tr></table></td>
<td width=133><table width="100%" border=0 cellspacing=0 cellpadding=0><tr valign=center align=center>
<td><div class=stabl><input name="%%STAB%%_4" width=14 height=14 type=image src="%%RF%%style/%%STYLE%%/image/sort.gif" title="%%SORTBYHT%%" border=0></div></td>
<td width="100%"><SPAN class=f11><a href="#hits" style="color:#000000"><b>%%HITS%%</b></a><b>, %</b></SPAN></td></tr></table></td></tr>
...
<td><SPAN class=f11>%%VISITORS%%</SPAN></td><td><SPAN class=f11>%%HOSTS%%</SPAN></td><td><SPAN class=f11>%%HITS%%</SPAN></td></tr>
...
<td><SPAN class=f11>%%HOSTS%%</SPAN></td><td><SPAN class=f11>%%HITS%%</SPAN></td></tr>
...
</tr></table></td><td><SPAN class=f11><b>-</b></SPAN></td><td><SPAN class=f11><b>-</b></SPAN></td><td><SPAN class=f11><b>-</b></SPAN></td></tr>
...
<td><SPAN class=f11><b>%%HOSTS%%</b></SPAN></td><td><SPAN class=f11><b>%%HITS%%</b></SPAN></td></tr>
