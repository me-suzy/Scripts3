<?php
$top=<<<TOP
<html><head><title>%%TITLE%%</title><meta http-equiv="Content-Type" content="text/html; charset=%%CHARSET%%">
<link rel="shortcut icon" href="%%RF%%data/favicon.ico" type="image/x-icon" />
<LINK href="%%RF%%style/%%STYLE%%/style.css" type=text/css rel=stylesheet><SCRIPT LANGUAGE="JavaScript">
<!--
...
&nbsp;&nbsp;<a href="%%SITE%%faq.html" target=_blank>%%FAQ%%</a>&nbsp;&nbsp;&nbsp;
&nbsp;<a href="http://www.actualscripts.com/products/support.php" target=_blank>%%SUPPORT%%</a>&nbsp;&nbsp;&nbsp;</div></td></tr>
